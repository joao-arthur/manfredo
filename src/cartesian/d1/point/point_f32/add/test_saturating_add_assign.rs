...
fn test() {
    ...
    saturating_add_assign(&mut p, &Point::new(10.0));
    assert_eq!(p, Point::new(10.0));
    saturating_add_assign(&mut p, &Point::new(-5.0));
...
fn to_bounds() {
    ...
    saturating_add_assign(&mut p_min, &Point::new(-2.0));
    assert_eq!(p_min, Point::min());

    let mut p_max = Point::new(MAX - 2.0);
    saturating_add_assign(&mut p_max, &Point::new(2.0));
...
fn out_of_bounds() {
    let mut p_min = Point::new(MIN + 2.0);
    saturating_add_assign(&mut p_min, &Point::new(-10.0));
    assert_eq!(p_min, Point::min());

    let mut p_max = Point::new(MAX - 2.0);
    saturating_add_assign(&mut p_max, &Point::new(10.0));
    assert_eq!(p_max, Point::max());
}
