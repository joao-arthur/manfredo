...
mod tests {
    use super::area;
    use crate::cartesian::d2::{circle::circle_u32::Circle, point::point_u32::Point};
    ...
    fn area_powers_of_10() {
        ...
        assert_eq!(area(&Circle::new(Point::min(), 100000)), 31_415_926_535.897_93);
        assert_eq!(area(&Circle::new(Point::min(), 1000000)), 3_141_592_653_589.793);
        assert_eq!(area(&Circle::new(Point::min(), 10000000)), 314_159_265_358_979.3);
    }

    #[test]
    fn area_bounds() {
        assert_eq!(area(&Circle::new(Point::min(), 0)), 0.0);
        assert_eq!(area(&Circle::new(Point::min(), u32::MAX)), 5.795215563763091e19);
    }
}
