...
mod tests {
    ...
    #[test]
    fn square() {
        assert_eq!(distance(&Point::new(-50.0, -50.0), &Point::new(50.0, 50.0)), 141.42136);
        assert_eq!(distance(&Point::new(-100.0, -100.0), &Point::new(100.0, 100.0)), 282.8427);

        assert_eq!(distance(&Point::zero(), &Point::new(141.42136, 141.42136)), 200.0);
        assert_eq!(distance(&Point::zero(), &Point::new(282.8427, 282.8427)), 400.0);
    }
}
