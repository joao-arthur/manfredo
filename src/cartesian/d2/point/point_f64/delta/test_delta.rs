...
fn test_delta() {
    ...
    assert_eq!(delta(&Point::of(-4_503_599_627_370_496.0, -4_503_599_627_370_496.0), &Point::of(4_503_599_627_370_495.0, 4_503_599_627_370_495.0)), Point::max());
}

#[test]
fn delta_min() {
    let p = Point::of(-4_503_599_627_370_496.0, -4_503_599_627_370_496.0);
    assert_eq!(delta(&p, &Point::of(-4_503_599_627_370_496.0, -4_503_599_627_370_496.0)), Point::zero());
...
fn delta_max() {
    ...
    assert_eq!(delta(&p, &Point::of(4_503_599_627_370_493.0, 4_503_599_627_370_493.0)), Point::zero());
