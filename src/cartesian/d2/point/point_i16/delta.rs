use super::Point;
use crate::cartesian::d2::point::point_u16;
...
mod tests {
    ...
    use crate::cartesian::{
        ...
        d2::point::{point_i16::Point, point_u16},
    };

    #[test]
    fn test_delta_x() {
        assert_eq!(delta_x(&Point::new(MIN, 0), &Point::new(MAX, 0)), u16::MAX);
    ...
    fn test_delta_y() {
        ...
        assert_eq!(delta_y(&Point::new(0, MIN), &Point::new(0, MAX)), u16::MAX);
    }
