...
fn test() {
    ...
    saturating_add_assign(&mut p, &Point::new(10, 13));
    assert_eq!(p, Point::new(10, 13));
    saturating_add_assign(&mut p, &Point::new(-5, -3));
...
fn to_bounds() {
    ...
    saturating_add_assign(&mut p_min, &Point::new(-2, -5));
    assert_eq!(p_min, Point::min());

    let mut p_max = Point::new(MAX - 2, MAX - 5);
    saturating_add_assign(&mut p_max, &Point::new(2, 5));
...
fn out_of_bounds() {
    let mut p_min = Point::new(MIN + 2, MIN + 5);
    saturating_add_assign(&mut p_min, &Point::new(-10, -10));
    assert_eq!(p_min, Point::min());

    let mut p_max = Point::new(MAX - 2, MAX - 5);
    saturating_add_assign(&mut p_max, &Point::new(10, 10));
    assert_eq!(p_max, Point::max());
}
