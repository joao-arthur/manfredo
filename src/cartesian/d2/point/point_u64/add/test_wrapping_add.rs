...
fn limits_out_of_bounds() {
    assert_eq!(wrapping_add(&Point::new(1, 1), &PointI::min()), Point::new(9223372036854775809, 9223372036854775809));
    assert_eq!(wrapping_add(&Point::new(MAX - 1, MAX - 1), &PointI::max()), Point::new(9223372036854775805, 9223372036854775805));
}
