...
#[test]
fn delta_max_bounds() {
    assert_eq!(delta_max(&Rect::new((MIN + 1, MIN), (MAX, MAX))), u64::MAX);
    assert_eq!(delta_max(&Rect::new((MIN, MIN + 1), (MAX, MAX))), u64::MAX);
    assert_eq!(delta_max(&Rect::new((MIN, MIN), (MAX - 1, MAX))), u64::MAX);
    assert_eq!(delta_max(&Rect::new((MIN, MIN), (MAX, MAX - 1))), u64::MAX);
}
