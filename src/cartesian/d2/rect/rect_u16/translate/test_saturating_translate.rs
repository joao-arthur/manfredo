...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(saturating_translate(&r, &Point::of(i16::MIN, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::of(0, i16::MIN)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::of(i16::MAX, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::of(0, i16::MAX)), Rect::largest());
}
