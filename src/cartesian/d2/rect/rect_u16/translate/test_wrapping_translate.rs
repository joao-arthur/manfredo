...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(wrapping_translate(&r, &Point::new(i16::MIN, 0)), Rect::new((MAX / 2 + 1, 0), (MAX / 2, MAX)));
    assert_eq!(wrapping_translate(&r, &Point::new(0, i16::MIN)), Rect::new((0, MAX / 2 + 1), (MAX, MAX / 2)));
    assert_eq!(wrapping_translate(&r, &Point::new(i16::MAX, 0)), Rect::new((MAX / 2, 0), (MAX / 2 - 1, MAX)));
    assert_eq!(wrapping_translate(&r, &Point::new(0, i16::MAX)), Rect::new((0, MAX / 2), (MAX, MAX / 2 - 1)));
}
