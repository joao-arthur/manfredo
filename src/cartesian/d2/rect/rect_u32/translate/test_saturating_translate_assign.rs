...
fn test() {
    ...
    saturating_translate_assign(&mut r, &Point::new(5, 4));
    assert_eq!(r, Rect::new((5, 4), (17, 19)));
    saturating_translate_assign(&mut r, &Point::new(-4, -2));
...
fn out_of_bounds() {
    ...
    assert_eq!(r1, Rect::new((0, 10), (MAX - 20, MAX - 10)));

    let mut r2 = Rect::new((10, 10), (MAX - 10, MAX - 10));
    saturating_translate_assign(&mut r2, &Point::new(0, -20));
    assert_eq!(r2, Rect::new((10, 0), (MAX - 10, MAX - 20)));

    let mut r3 = Rect::new((10, 10), (MAX - 10, MAX - 10));
    saturating_translate_assign(&mut r3, &Point::new(20, 0));
    assert_eq!(r3, Rect::new((20, 10), (MAX, MAX - 10)));

    let mut r4 = Rect::new((10, 10), (MAX - 10, MAX - 10));
    saturating_translate_assign(&mut r4, &Point::new(0, 20));
    assert_eq!(r4, Rect::new((10, 20), (MAX - 10, MAX)));
}

#[test]
fn limits_out_of_bounds() {
    let mut r = Rect::largest();
    saturating_translate_assign(&mut r, &Point::new(i32::MIN, 0));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::new(0, i32::MIN));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::new(i32::MAX, 0));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::new(0, i32::MAX));
    assert_eq!(r, Rect::largest());
}
