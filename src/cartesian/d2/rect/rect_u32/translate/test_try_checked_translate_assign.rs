...
fn limits_out_of_bounds() {
    ...
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(i32::MIN, 0)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(0, i32::MIN)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(i32::MAX, 0)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(0, i32::MAX)), None);
