...
#[test]
fn test() {
    assert_eq!(try_checked_add(&Rect::of((0, 0), (12, 10)), &RectI::of((5, 4), (3, 2))), Some(Rect::of((5, 4), (15, 12))));
    assert_eq!(try_checked_add(&Rect::of((5, 4), (15, 12)), &RectI::of((-4, -3), (-2, -1))), Some(Rect::of((1, 1), (13, 11))));
}
...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(try_checked_add(&r, &RectI::of((i64::MIN, 0), (0, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::of((0, i64::MIN), (0, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::of((0, 0), (i64::MAX, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::of((0, 0), (0, i64::MAX))), None);
}
