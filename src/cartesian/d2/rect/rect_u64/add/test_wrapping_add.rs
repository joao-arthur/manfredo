...
#[test]
fn test() {
    assert_eq!(wrapping_add(&Rect::new((0, 0), (12, 10)), &RectI::new((5, 4), (3, 2))), Rect::new((5, 4), (15, 12)));
    assert_eq!(wrapping_add(&Rect::new((5, 4), (15, 12)), &RectI::new((-4, -3), (-2, -1))), Rect::new((1, 1), (13, 11)));
}
...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(wrapping_add(&r, &RectI::new((i64::MIN, 0), (0, 0))), Rect::new((MAX / 2 + 1, 0), (MAX, MAX)));
    assert_eq!(wrapping_add(&r, &RectI::new((0, i64::MIN), (0, 0))), Rect::new((0, MAX / 2 + 1), (MAX, MAX)));
    assert_eq!(wrapping_add(&r, &RectI::new((0, 0), (i64::MAX, 0))), Rect::new((0, 0), (MAX / 2 - 1, MAX)));
    assert_eq!(wrapping_add(&r, &RectI::new((0, 0), (0, i64::MAX))), Rect::new((0, 0), (MAX, MAX / 2 - 1)));
}
