...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(try_checked_translate(&r, &Point::new(i64::MIN, 0)), None);
    assert_eq!(try_checked_translate(&r, &Point::new(0, i64::MIN)), None);
    assert_eq!(try_checked_translate(&r, &Point::new(i64::MAX, 0)), None);
    assert_eq!(try_checked_translate(&r, &Point::new(0, i64::MAX)), None);
}
