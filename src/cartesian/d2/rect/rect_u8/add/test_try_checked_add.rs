...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(try_checked_add(&r, &RectI::new((i8::MIN, 0), (0, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::new((0, i8::MIN), (0, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::new((0, 0), (i8::MAX, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::new((0, 0), (0, i8::MAX))), None);
}
