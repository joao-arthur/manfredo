...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(wrapping_add(&r, &RectI::new((i8::MIN, 0), (0, 0))), Rect::new((MAX / 2 + 1, 0), (MAX, MAX)));
    assert_eq!(wrapping_add(&r, &RectI::new((0, i8::MIN), (0, 0))), Rect::new((0, MAX / 2 + 1), (MAX, MAX)));
    assert_eq!(wrapping_add(&r, &RectI::new((0, 0), (i8::MAX, 0))), Rect::new((0, 0), (MAX / 2 - 1, MAX)));
    assert_eq!(wrapping_add(&r, &RectI::new((0, 0), (0, i8::MAX))), Rect::new((0, 0), (MAX, MAX / 2 - 1)));
}
