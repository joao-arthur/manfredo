...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(wrapping_translate(&r, &Point::of(i8::MIN, 0)), Rect::of(MAX / 2 + 1, 0, MAX / 2, MAX));
    assert_eq!(wrapping_translate(&r, &Point::of(0, i8::MIN)), Rect::of(0, MAX / 2 + 1, MAX, MAX / 2));
    assert_eq!(wrapping_translate(&r, &Point::of(i8::MAX, 0)), Rect::of(MAX / 2, 0, MAX / 2 - 1, MAX));
    assert_eq!(wrapping_translate(&r, &Point::of(0, i8::MAX)), Rect::of(0, MAX / 2, MAX, MAX / 2 - 1));
}
