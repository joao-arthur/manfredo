...
mod tests {
    ...
    #[test]
    fn test_delta_x() {
        assert_eq!(delta_x(&Point::of(MIN, 0, 0, 0), &Point::of(MAX, 0, 0, 0)), u16::MAX);
    ...
    fn test_delta_y() {
        ...
        assert_eq!(delta_y(&Point::of(0, MIN, 0, 0), &Point::of(0, MAX, 0, 0)), u16::MAX);
    ...
    fn test_delta_z() {
        ...
        assert_eq!(delta_z(&Point::of(0, 0, MIN, 0), &Point::of(0, 0, MAX, 0)), u16::MAX);
    ...
    fn test_delta_w() {
        ...
        assert_eq!(delta_w(&Point::of(0, 0, 0, MIN), &Point::of(0, 0, 0, MAX)), u16::MAX);
    }
