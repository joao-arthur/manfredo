...
mod tests {
    ...
    fn try_checked_add_to_bounds() {
        assert_eq!(try_checked_add(&PointI8::of(i8::MIN + 2, i8::MIN + 5), &PointI8::of(-2, -5)), Some(PointI8::min()));
        assert_eq!(try_checked_add(&PointI8::of(i8::MAX - 2, i8::MAX - 5), &PointI8::of(2, 5)), Some(PointI8::max()));
    }
