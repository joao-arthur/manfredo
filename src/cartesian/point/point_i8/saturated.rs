...
mod tests {
    ...
    fn add_out_of_bounds() {
        assert_eq!(add(&PointI8::of(i8::MIN + 2, i8::MIN + 5), &PointI8::of(-10, -10)), PointI8::min());
        assert_eq!(add(&PointI8::of(i8::MAX - 2, i8::MAX - 5), &PointI8::of(10, 10)), PointI8::max());
    }

    #[test]
    fn add_limits_out_of_bounds() {
        assert_eq!(add(&PointI8::of(i8::MIN + 1, i8::MIN + 1), &PointI8::min()), PointI8::min());
        assert_eq!(add(&PointI8::of(i8::MAX - 1, i8::MAX - 1), &PointI8::max()), PointI8::max());
    }
}
