...
#[cfg(test)]
mod tests {
    use super::{PointU16, wrapping_add, wrapping_add_assign};
    ...
    fn wrapping_add_to_bounds() {
        ...
        assert_eq!(wrapping_add(&PointU16::of(u16::MAX - 2, u16::MAX - 5), &PointI16::of(2, 5)), PointU16::max());
    }

    #[test]
    fn wrapping_add_out_of_bounds() {
        assert_eq!(wrapping_add(&PointU16::of(2, 5), &PointI16::of(-10, -10)), PointU16::of(u16::MAX - 7, u16::MAX - 4));
        assert_eq!(wrapping_add(&PointU16::of(u16::MAX - 2, u16::MAX - 5), &PointI16::of(10, 10)), PointU16::of(7, 4));
    }

    #[test]
    fn wrapping_add_limits_out_of_bounds() {
        assert_eq!(wrapping_add(&PointU16::of(1, 1), &PointI16::min()), PointU16::of(32769, 32769));
        assert_eq!(wrapping_add(&PointU16::of(u16::MAX - 1, u16::MAX - 1), &PointI16::max()), PointU16::of(32765, 32765));
    }
}
