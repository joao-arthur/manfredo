...
#[cfg(test)]
mod tests {
    use super::{PointU32, wrapping_add, wrapping_add_assign};
    ...
    fn wrapping_add_to_bounds() {
        ...
        assert_eq!(wrapping_add(&PointU32::of(u32::MAX - 2, u32::MAX - 5), &PointI32::of(2, 5)), PointU32::max());
    }

    #[test]
    fn wrapping_add_out_of_bounds() {
        assert_eq!(wrapping_add(&PointU32::of(2, 5), &PointI32::of(-10, -10)), PointU32::of(u32::MAX - 7, u32::MAX - 4));
        assert_eq!(wrapping_add(&PointU32::of(u32::MAX - 2, u32::MAX - 5), &PointI32::of(10, 10)), PointU32::of(7, 4));
    }
    ...
    fn wrapping_add_limits_out_of_bounds() {
        ...
        assert_eq!(wrapping_add(&PointU32::of(u32::MAX - 1, u32::MAX - 1), &PointI32::max()), PointU32::of(2147483645, 2147483645));
    }
}
