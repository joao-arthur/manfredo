...
mod tests {
    ...
    fn test_try_checked_add_assign() {
        ...
        assert_eq!(try_checked_add_assign(&mut p, &PointI64::of(-5, -3)), Some(()));
    ...
    fn try_checked_add_to_bounds() {
        ...
        assert_eq!(try_checked_add(&PointU64::of(u64::MAX - 2, u64::MAX - 5), &PointI64::of(2, 5)), Some(PointU64::max()));
    }
    ...
    fn test_checked_add_assign() {
        ...
        assert_eq!(p, PointU64::of(10, 13));
        checked_add_assign(&mut p, &PointI64::of(-5, -3));
        assert_eq!(p, PointU64::of(5, 10));
    }

    #[test]
    fn test_checked_add() {
        assert_eq!(checked_add(&PointU64::min(), &PointI64::of(10, 13)), PointU64::of(10, 13));
