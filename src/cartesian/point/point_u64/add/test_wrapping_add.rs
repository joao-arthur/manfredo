...
use crate::cartesian::point::{point_i64::Point as PointI, point_u64::Point};
...
fn limits_out_of_bounds() {
    assert_eq!(wrapping_add(&Point::of(1, 1), &PointI::min()), Point::of(9223372036854775809, 9223372036854775809));
    assert_eq!(wrapping_add(&Point::of(MAX - 1, MAX - 1), &PointI::max()), Point::of(9223372036854775805, 9223372036854775805));
}
