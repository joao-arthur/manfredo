...
mod tests {
    ...
    fn wrapping_add_to_bounds() {
        ...
        assert_eq!(wrapping_add(&PointU64::of(MAX - 2, MAX - 5), &PointI64::of(2, 5)), PointU64::max());
    }

    #[test]
    fn wrapping_add_out_of_bounds() {
        assert_eq!(wrapping_add(&PointU64::of(2, 5), &PointI64::of(-10, -10)), PointU64::of(MAX - 7, MAX - 4));
        assert_eq!(wrapping_add(&PointU64::of(MAX - 2, MAX - 5), &PointI64::of(10, 10)), PointU64::of(7, 4));
    }
    ...
    fn wrapping_add_limits_out_of_bounds() {
        ...
        assert_eq!(wrapping_add(&PointU64::of(MAX - 1, MAX - 1), &PointI64::max()), PointU64::of(9223372036854775805, 9223372036854775805));
    }
}
