...
mod tests {
    ...
    fn add_big_rect_out_of_bounds() {
        assert_eq!(add(&RectF32::of(MIN + 10.0, MIN + 5.0, MAX, MAX), &RectF32::of(-20.0, -20.0, 0.0, 0.0)), RectF32::of(MAX - 9.0, MAX - 14.0, MAX, MAX));
        assert_eq!(add(&RectF32::of(MIN, MIN, MAX - 5.0, MAX - 10.0), &RectF32::of(0.0, 0.0, 20.0, 20.0)), RectF32::of(MIN, MIN, MIN + 14.0, MIN + 9.0));
    }
