...
fn to_bounds() {
    ...
    assert_eq!(try_saturating_inflate(&RectF32::of(MIN + 1.0, MIN + 10.0, MAX - 10.0, MAX - 10.0)), Some(RectF32::of(MIN, MIN + 9.0, MAX - 9.0, MAX - 9.0)));
    assert_eq!(try_saturating_inflate(&RectF32::of(MIN + 10.0, MIN + 1.0, MAX - 10.0, MAX - 10.0)), Some(RectF32::of(MIN + 9.0, MIN, MAX - 9.0, MAX - 9.0)));
    assert_eq!(try_saturating_inflate(&RectF32::of(MIN + 10.0, MIN + 10.0, MAX - 1.0, MAX - 10.0)), Some(RectF32::of(MIN + 9.0, MIN + 9.0, MAX, MAX - 9.0)));
    assert_eq!(try_saturating_inflate(&RectF32::of(MIN + 10.0, MIN + 10.0, MAX - 10.0, MAX - 1.0)), Some(RectF32::of(MIN + 9.0, MIN + 9.0, MAX - 9.0, MAX)));
}
#[test]
fn out_of_bounds() {
