...
fn out_of_bounds() {
    ...
    let mut r_x = RectF32::of(MIN, MIN + 10.0, MAX, MAX - 10.0);
    assert_eq!(try_saturating_inflate_assign(&mut r_x), None);
    assert_eq!(r_x, RectF32::of(MIN, MIN + 10.0, MAX, MAX - 10.0));

    let mut r_y = RectF32::of(MIN + 10.0, MIN, MAX - 10.0, MAX);
    assert_eq!(try_saturating_inflate_assign(&mut r_y), None);
    assert_eq!(r_y, RectF32::of(MIN + 10.0, MIN, MAX - 10.0, MAX));
}
