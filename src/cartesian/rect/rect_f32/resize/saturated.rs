...
mod tests {
    ...
    fn try_saturating_resize_assign_odd() {
        ...
        assert_eq!(try_saturating_resize_assign(&mut r, 11.0), Some(()));
    ...
    fn try_saturating_resize_assign_even_small_rect_limits_out_of_bounds() {
        let mut r = RectF32::of(MIN, MIN, MIN + 3.0, MIN + 3.0);
        assert_eq!(try_saturating_resize_assign(&mut r, MAX - 1.0), Some(()));
    ...
    fn try_saturating_resize_odd() {
        assert_eq!(try_saturating_resize(&RectF32::of(-5.0, -5.0, 5.0, 5.0), 11.0), Some(RectF32::of(-5.0, -5.0, 5.0, 5.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-5.0, -5.0, 5.0, 5.0), 9.0), Some(RectF32::of(-4.0, -4.0, 4.0, 4.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-4.0, -4.0, 4.0, 4.0), 7.0), Some(RectF32::of(-3.0, -3.0, 3.0, 3.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-3.0, -3.0, 3.0, 3.0), 5.0), Some(RectF32::of(-2.0, -2.0, 2.0, 2.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-2.0, -2.0, 2.0, 2.0), 3.0), Some(RectF32::of(-1.0, -1.0, 1.0, 1.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-1.0, -1.0, 1.0, 1.0), 9.0), Some(RectF32::of(-4.0, -4.0, 4.0, 4.0)));
    }

    #[test]
    fn try_saturating_resize_even() {
        assert_eq!(try_saturating_resize(&RectF32::of(-5.0, -5.0, 4.0, 4.0), 10.0), Some(RectF32::of(-5.0, -5.0, 4.0, 4.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-5.0, -5.0, 4.0, 4.0), 8.0), Some(RectF32::of(-4.0, -4.0, 3.0, 3.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-4.0, -4.0, 3.0, 3.0), 6.0), Some(RectF32::of(-3.0, -3.0, 2.0, 2.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-3.0, -3.0, 2.0, 2.0), 4.0), Some(RectF32::of(-2.0, -2.0, 1.0, 1.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(-2.0, -2.0, 1.0, 1.0), 8.0), Some(RectF32::of(-4.0, -4.0, 3.0, 3.0)));
    }
    ...
    fn try_saturating_resize_same_size() {
        assert_eq!(try_saturating_resize(&RectF32::of(10.0, 10.0, 20.0, 20.0), 11.0), Some(RectF32::of(10.0, 10.0, 20.0, 20.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(10.0, 10.0, 21.0, 21.0), 12.0), Some(RectF32::of(10.0, 10.0, 21.0, 21.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(9.0, 9.0, 21.0, 21.0), 13.0), Some(RectF32::of(9.0, 9.0, 21.0, 21.0)));
    }

    #[test]
    fn try_saturating_resize_odd_small_rect_out_of_bounds() {
        assert_eq!(try_saturating_resize(&RectF32::of(MIN, MIN, MIN + 2.0, MIN + 2.0), 11.0), Some(RectF32::of(MIN, MIN, MIN + 10.0, MIN + 10.0)));
    ...
    fn try_saturating_resize_even_small_rect_out_of_bounds() {
        assert_eq!(try_saturating_resize(&RectF32::of(MIN, MIN, MIN + 3.0, MIN + 3.0), 11.0), Some(RectF32::of(MIN, MIN, MIN + 10.0, MIN + 10.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(MAX - 3.0, MAX - 3.0, MAX, MAX), 11.0), Some(RectF32::of(MAX - 10.0, MAX - 10.0, MAX, MAX)));
    }
    ...
    fn try_saturating_resize_even_small_rect_limits_out_of_bounds() {
        assert_eq!(try_saturating_resize(&RectF32::of(MIN, MIN, MIN + 3.0, MIN + 3.0), MAX - 1.0), Some(RectF32::of(MIN, MIN, -3.0, -3.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(MAX - 3.0, MAX - 3.0, MAX, MAX), MAX - 1.0), Some(RectF32::of(2.0, 2.0, MAX, MAX)));
    }

    #[test]
    fn try_saturating_resize_big_rect_limits_out_of_bounds() {
        assert_eq!(try_saturating_resize(&RectF32::of(MIN, MIN, -1.0, -1.0), MAX), Some(RectF32::of(MIN, MIN, -2.0, -2.0)));
        assert_eq!(try_saturating_resize(&RectF32::of(1.0, 1.0, MAX, MAX), MAX), Some(RectF32::of(1.0, 1.0, MAX, MAX)));
        assert_eq!(try_saturating_resize(&RectF32::largest(), MAX), Some(RectF32::of(MIN / 2.0, MIN / 2.0, (MAX - 3.0) / 2.0, (MAX - 3.0) / 2.0)));
    }

    #[test]
    fn saturating_resize_assign_odd() {
        let mut r = RectF32::of(-5.0, -5.0, 5.0, 5.0);
        saturating_resize_assign(&mut r, 11.0);
        assert_eq!(r, RectF32::of(-5.0, -5.0, 5.0, 5.0));
        saturating_resize_assign(&mut r, 9.0);
        assert_eq!(r, RectF32::of(-4.0, -4.0, 4.0, 4.0));
        saturating_resize_assign(&mut r, 7.0);
        assert_eq!(r, RectF32::of(-3.0, -3.0, 3.0, 3.0));
        saturating_resize_assign(&mut r, 5.0);
        assert_eq!(r, RectF32::of(-2.0, -2.0, 2.0, 2.0));
        saturating_resize_assign(&mut r, 3.0);
        assert_eq!(r, RectF32::of(-1.0, -1.0, 1.0, 1.0));
        saturating_resize_assign(&mut r, 9.0);
        assert_eq!(r, RectF32::of(-4.0, -4.0, 4.0, 4.0));
    }
    ...
    fn saturating_resize_assign_even() {
        let mut r = RectF32::of(-5.0, -5.0, 4.0, 4.0);
        saturating_resize_assign(&mut r, 10.0);
        assert_eq!(r, RectF32::of(-5.0, -5.0, 4.0, 4.0));
        saturating_resize_assign(&mut r, 8.0);
        assert_eq!(r, RectF32::of(-4.0, -4.0, 3.0, 3.0));
        saturating_resize_assign(&mut r, 6.0);
        assert_eq!(r, RectF32::of(-3.0, -3.0, 2.0, 2.0));
        saturating_resize_assign(&mut r, 4.0);
        assert_eq!(r, RectF32::of(-2.0, -2.0, 1.0, 1.0));
        saturating_resize_assign(&mut r, 8.0);
        assert_eq!(r, RectF32::of(-4.0, -4.0, 3.0, 3.0));
    }
    ...
    fn saturating_resize_odd() {
        assert_eq!(saturating_resize(&RectF32::of(-5.0, -5.0, 5.0, 5.0), 11.0), RectF32::of(-5.0, -5.0, 5.0, 5.0));
        assert_eq!(saturating_resize(&RectF32::of(-5.0, -5.0, 5.0, 5.0), 9.0), RectF32::of(-4.0, -4.0, 4.0, 4.0));
        assert_eq!(saturating_resize(&RectF32::of(-4.0, -4.0, 4.0, 4.0), 7.0), RectF32::of(-3.0, -3.0, 3.0, 3.0));
        assert_eq!(saturating_resize(&RectF32::of(-3.0, -3.0, 3.0, 3.0), 5.0), RectF32::of(-2.0, -2.0, 2.0, 2.0));
        assert_eq!(saturating_resize(&RectF32::of(-2.0, -2.0, 2.0, 2.0), 3.0), RectF32::of(-1.0, -1.0, 1.0, 1.0));
        assert_eq!(saturating_resize(&RectF32::of(-1.0, -1.0, 1.0, 1.0), 9.0), RectF32::of(-4.0, -4.0, 4.0, 4.0));
    }

    #[test]
    fn saturating_resize_even() {
        assert_eq!(saturating_resize(&RectF32::of(-5.0, -5.0, 4.0, 4.0), 10.0), RectF32::of(-5.0, -5.0, 4.0, 4.0));
        assert_eq!(saturating_resize(&RectF32::of(-5.0, -5.0, 4.0, 4.0), 8.0), RectF32::of(-4.0, -4.0, 3.0, 3.0));
        assert_eq!(saturating_resize(&RectF32::of(-4.0, -4.0, 3.0, 3.0), 6.0), RectF32::of(-3.0, -3.0, 2.0, 2.0));
        assert_eq!(saturating_resize(&RectF32::of(-3.0, -3.0, 2.0, 2.0), 4.0), RectF32::of(-2.0, -2.0, 1.0, 1.0));
        assert_eq!(saturating_resize(&RectF32::of(-2.0, -2.0, 1.0, 1.0), 8.0), RectF32::of(-4.0, -4.0, 3.0, 3.0));
    }
}
