...
fn out_of_bounds() {
    ...
    assert_eq!(wrapping_translate(&r, &PointF32::of(-20.0, 0.0)), RectF32::of(MAX - 9.0, MIN + 10.0, MAX - 30.0, MAX - 10.0));
...
fn edge_out_of_bounds() {
    ...
    assert_eq!(wrapping_translate(&r, &PointF32::of(-1.0, 0.0)), RectF32::of(MAX, MIN, MAX - 1.0, MAX));
    assert_eq!(wrapping_translate(&r, &PointF32::of(0.0, -1.0)), RectF32::of(MIN, MAX, MAX, MAX - 1.0));
    assert_eq!(wrapping_translate(&r, &PointF32::of(1.0, 0.0)), RectF32::of(MIN + 1.0, MIN, MIN, MAX));
    assert_eq!(wrapping_translate(&r, &PointF32::of(0.0, 1.0)), RectF32::of(MIN, MIN + 1.0, MAX, MIN));
}

#[test]
fn limits_out_of_bounds() {
    let r = RectF32::largest();
    assert_eq!(wrapping_translate(&r, &PointF32::of(MIN, 0.0)), RectF32::of(0.0, MIN, -1.0, MAX));
    assert_eq!(wrapping_translate(&r, &PointF32::of(0.0, MIN)), RectF32::of(MIN, 0.0, MAX, -1.0));
    assert_eq!(wrapping_translate(&r, &PointF32::of(MAX, 0.0)), RectF32::of(-1.0, MIN, -2.0, MAX));
    assert_eq!(wrapping_translate(&r, &PointF32::of(0.0, MAX)), RectF32::of(MIN, -1.0, MAX, -2.0));
}
