...
mod tests {
    ...
    fn wrapping_translate_small_rect_to_bounds() {
        assert_eq!(
            wrapping_translate(&RectF32::of(MIN + 2.0, MIN + 5.0, MIN + 12.0, MIN + 15.0), &PointF32::of(-2.0, -5.0)),
            RectF32::of(MIN, MIN, MIN + 10.0, MIN + 10.0)
        );
        assert_eq!(
            wrapping_translate(&RectF32::of(MAX - 12.0, MAX - 15.0, MAX - 2.0, MAX - 5.0), &PointF32::of(2.0, 5.0)),
    ...
    fn wrapping_translate_small_rect_out_of_bounds() {
        assert_eq!(
            wrapping_translate(&RectF32::of(MIN + 10.0, MIN + 5.0, MIN + 20.0, MIN + 30.0), &PointF32::of(-20.0, -20.0)),
            RectF32::of(MAX - 9.0, MAX - 14.0, MIN, MIN + 10.0)
        );
        assert_eq!(
            wrapping_translate(&RectF32::of(MAX - 20.0, MAX - 30.0, MAX - 5.0, MAX - 10.0), &PointF32::of(20.0, 20.0)),
    ...
    fn wrapping_translate_big_rect_out_of_bounds() {
        assert_eq!(
            wrapping_translate(&RectF32::of(MIN + 10.0, MIN + 5.0, MAX, MAX), &PointF32::of(-20.0, -20.0)),
            RectF32::of(MAX - 9.0, MAX - 14.0, MAX - 20.0, MAX - 20.0)
        );
        assert_eq!(
            wrapping_translate(&RectF32::of(MIN, MIN, MAX - 5.0, MAX - 10.0), &PointF32::of(20.0, 20.0)),
