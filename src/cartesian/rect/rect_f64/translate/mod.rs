...
pub fn try_checked_translate_assign(r: &mut RectF64, delta: &PointF64) -> Option<()> {
...
pub fn try_checked_translate(r: &RectF64, delta: &PointF64) -> Option<RectF64> {
    if delta.x < MIN - r.min.x || delta.y < MIN - r.min.y || delta.x > MAX - r.max.x || delta.y > MAX - r.max.y {
        return None;
    }
...
pub fn checked_translate_assign(r: &mut RectF64, delta: &PointF64) {
    try_checked_translate_assign(r, delta).unwrap()
}

pub fn checked_translate(r: &RectF64, delta: &PointF64) -> RectF64 {
    try_checked_translate(r, delta).unwrap()
}

pub fn saturating_translate_assign(r: &mut RectF64, delta: &PointF64) {
...
pub fn saturating_translate(r: &RectF64, delta: &PointF64) -> RectF64 {
    let dx = delta_x(r).clamp(MIN, MAX);
    let dy = delta_y(r).clamp(MIN, MAX);
    let temp_min_x = r.min.x + delta.x;
    let temp_min_y = r.min.y + delta.y;
...
pub fn wrapping_translate_assign(r: &mut RectF64, delta: &PointF64) {
...
pub fn wrapping_translate(r: &RectF64, delta: &PointF64) -> RectF64 {
