...
mod tests {
    ...
    fn wrapping_add_big_rect_to_bounds() {
        assert_eq!(
            wrapping_add(&RectI16::of(i16::MIN + 2, i16::MIN + 5, i16::MAX - 2, i16::MAX - 5), &RectI16::of(-2, -5, 2, 5)),
            RectI16::largest()
        );
    ...
    fn wrapping_add_small_rect_limits_out_of_bounds() {
        ...
        assert_eq!(
            wrapping_add(&RectI16::of(i16::MAX - 10, i16::MAX - 10, i16::MAX - 1, i16::MAX - 1), &RectI16::max()),
