...
fn to_bounds() {
    ...
    let mut r_min_x = RectI16::of(i16::MIN + 1, i16::MIN + 10, i16::MAX - 10, i16::MAX - 10);
    wrapping_inflate_assign(&mut r_min_x);
    assert_eq!(r_min_x, RectI16::of(i16::MIN, i16::MIN + 9, i16::MAX - 9, i16::MAX - 9));
...
fn out_of_bounds() {
    ...
    let mut r_min_x = RectI16::of(i16::MIN, i16::MIN + 10, i16::MAX - 10, i16::MAX - 10);
    wrapping_inflate_assign(&mut r_min_x);
    assert_eq!(r_min_x, RectI16::of(i16::MAX, i16::MIN + 9, i16::MAX - 9, i16::MAX - 9));
