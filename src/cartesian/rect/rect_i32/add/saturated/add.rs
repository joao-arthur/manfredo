...
mod tests {
    ...
    fn add_edge_out_of_bounds() {
        ...
        assert_eq!(add(&r, &RectI32::of(-1, 0, 0, 0)), RectI32::largest());
        assert_eq!(add(&r, &RectI32::of(0, -1, 0, 0)), RectI32::largest());
        assert_eq!(add(&r, &RectI32::of(0, 0, 1, 0)), RectI32::largest());
        assert_eq!(add(&r, &RectI32::of(0, 0, 0, 1)), RectI32::largest());
    }

    #[test]
    fn add_out_of_bounds() {
        let r = RectI32::of(i32::MIN + 10, i32::MIN + 10, i32::MAX - 10, i32::MAX - 10);
        assert_eq!(add(&r, &RectI32::of(-20, 0, 0, 0)), RectI32::of(i32::MIN, i32::MIN + 10, i32::MAX - 10, i32::MAX - 10));
        assert_eq!(add(&r, &RectI32::of(0, -20, 0, 0)), RectI32::of(i32::MIN + 10, i32::MIN, i32::MAX - 10, i32::MAX - 10));
        assert_eq!(add(&r, &RectI32::of(0, 0, 20, 0)), RectI32::of(i32::MIN + 10, i32::MIN + 10, i32::MAX, i32::MAX - 10));
        assert_eq!(add(&r, &RectI32::of(0, 0, 0, 20)), RectI32::of(i32::MIN + 10, i32::MIN + 10, i32::MAX - 10, i32::MAX));
    }

    #[test]
    fn add_limits_out_of_bounds() {
        let r = RectI32::largest();
        assert_eq!(add(&r, &RectI32::of(i32::MIN, 0, 0, 0)), RectI32::largest());
        assert_eq!(add(&r, &RectI32::of(0, i32::MIN, 0, 0)), RectI32::largest());
        assert_eq!(add(&r, &RectI32::of(0, 0, i32::MAX, 0)), RectI32::largest());
        assert_eq!(add(&r, &RectI32::of(0, 0, 0, i32::MAX)), RectI32::largest());
    }
}
