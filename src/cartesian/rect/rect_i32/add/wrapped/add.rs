...
mod tests {
    ...
    fn wrapping_add_big_rect_to_bounds() {
        assert_eq!(
            wrapping_add(&RectI32::of(i32::MIN + 2, i32::MIN + 5, i32::MAX - 2, i32::MAX - 5), &RectI32::of(-2, -5, 2, 5)),
            RectI32::largest()
        );
    ...
    fn wrapping_add_small_rect_limits_out_of_bounds() {
        ...
        assert_eq!(
            wrapping_add(&RectI32::of(i32::MAX - 10, i32::MAX - 10, i32::MAX - 1, i32::MAX - 1), &RectI32::max()),
