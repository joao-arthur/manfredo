...
mod tests {
    ...
    fn try_inflate_min_bounds() {
        assert_eq!(
            try_inflate(&RectI32::of(i32::MIN + 7, i32::MIN + 3, i32::MIN + 9, i32::MIN + 13)),
            Some(RectI32::of(i32::MIN + 6, i32::MIN + 2, i32::MIN + 10, i32::MIN + 14))
        );
        assert_eq!(
            try_inflate(&RectI32::of(i32::MIN + 6, i32::MIN + 2, i32::MIN + 10, i32::MIN + 14)),
            Some(RectI32::of(i32::MIN + 5, i32::MIN + 1, i32::MIN + 11, i32::MIN + 15))
        );
        assert_eq!(
            try_inflate(&RectI32::of(i32::MIN + 5, i32::MIN + 1, i32::MIN + 11, i32::MIN + 15)),
    ...
    fn try_inflate_out_of_bounds() {
        ...
        assert_eq!(try_inflate(&RectI32::of(i32::MIN + 10, i32::MIN + 10, i32::MAX, i32::MIN + 20)), None);
        assert_eq!(try_inflate(&RectI32::of(i32::MIN + 10, i32::MIN, i32::MIN + 20, i32::MIN + 20)), None);
        assert_eq!(try_inflate(&RectI32::of(i32::MIN + 10, i32::MIN + 10, i32::MIN + 20, i32::MAX)), None);
        assert_eq!(try_inflate(&RectI32::of(i32::MIN, i32::MIN, i32::MIN + 10, i32::MIN + 10)), None);
        assert_eq!(try_inflate(&RectI32::of(i32::MIN + 10, i32::MIN + 10, i32::MAX, i32::MAX)), None);
    }
    ...
    fn inflate_min_bounds() {
        assert_eq!(
            inflate(&RectI32::of(i32::MIN + 7, i32::MIN + 3, i32::MIN + 9, i32::MIN + 13)),
            RectI32::of(i32::MIN + 6, i32::MIN + 2, i32::MIN + 10, i32::MIN + 14)
        );
        assert_eq!(
            inflate(&RectI32::of(i32::MIN + 6, i32::MIN + 2, i32::MIN + 10, i32::MIN + 14)),
            RectI32::of(i32::MIN + 5, i32::MIN + 1, i32::MIN + 11, i32::MIN + 15)
        );
        assert_eq!(
            inflate(&RectI32::of(i32::MIN + 5, i32::MIN + 1, i32::MIN + 11, i32::MIN + 15)),
