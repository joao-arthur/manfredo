...
#[test]
fn min_bounds() {
    let mut r = RectI32::of(MIN + 7, MIN + 3, MIN + 9, MIN + 13);
    wrapping_inflate_assign(&mut r);
    assert_eq!(r, RectI32::of(MIN + 6, MIN + 2, MIN + 10, MIN + 14));
    wrapping_inflate_assign(&mut r);
    assert_eq!(r, RectI32::of(MIN + 5, MIN + 1, MIN + 11, MIN + 15));
    wrapping_inflate_assign(&mut r);
    assert_eq!(r, RectI32::of(MIN + 4, MIN, MIN + 12, MIN + 16));
}
...
fn to_bounds() {
    ...
    let mut r_min_x = RectI32::of(MIN + 1, MIN + 10, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_x);
    assert_eq!(r_min_x, RectI32::of(MIN, MIN + 9, MAX - 9, MAX - 9));
...
fn out_of_bounds() {
    ...
    wrapping_inflate_assign(&mut r);
    assert_eq!(r, RectI32::of(MAX, MAX, MIN, MIN));

    let mut r_min_x = RectI32::of(MIN, MIN + 10, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_x);
    assert_eq!(r_min_x, RectI32::of(MAX, MIN + 9, MAX - 9, MAX - 9));

    let mut r_min_y = RectI32::of(MIN + 10, MIN, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_y);
    assert_eq!(r_min_y, RectI32::of(MIN + 9, MAX, MAX - 9, MAX - 9));

    let mut r_max_x = RectI32::of(MIN + 10, MIN + 10, MAX, MAX - 10);
    wrapping_inflate_assign(&mut r_max_x);
    assert_eq!(r_max_x, RectI32::of(MIN + 9, MIN + 9, MIN, MAX - 9));

    let mut r_max_y = RectI32::of(MIN + 10, MIN + 10, MAX - 10, MAX);
    wrapping_inflate_assign(&mut r_max_y);
    assert_eq!(r_max_y, RectI32::of(MIN + 9, MIN + 9, MAX - 9, MIN));
}
