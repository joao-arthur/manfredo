...
mod tests {
    ...
    fn wrapping_translate_small_rect_to_bounds() {
        assert_eq!(wrapping_translate(&RectI32::of(i32::MIN + 2, i32::MIN + 5, i32::MIN + 12, i32::MIN + 15), &PointI32::of(-2, -5)), RectI32::of(i32::MIN, i32::MIN, i32::MIN + 10, i32::MIN + 10));
        assert_eq!(wrapping_translate(&RectI32::of(i32::MAX - 12, i32::MAX - 15, i32::MAX - 2, i32::MAX - 5), &PointI32::of(2, 5)), RectI32::of(i32::MAX - 10, i32::MAX - 10, i32::MAX, i32::MAX));
    }
    ...
    fn wrapping_translate_big_rect_out_of_bounds() {
        assert_eq!(wrapping_translate(&RectI32::of(i32::MIN + 10, i32::MIN + 5, i32::MAX, i32::MAX), &PointI32::of(-20, -20)), RectI32::of(i32::MAX - 9, i32::MAX - 14, i32::MAX - 20, i32::MAX - 20));
        assert_eq!(wrapping_translate(&RectI32::of(i32::MIN, i32::MIN, i32::MAX - 5, i32::MAX - 10), &PointI32::of(20, 20)), RectI32::of(i32::MIN + 20, i32::MIN + 20, i32::MIN + 14, i32::MIN + 9));
    }
    ...
    fn wrapping_translate_small_rect_limits_out_of_bounds() {
        ...
        assert_eq!(wrapping_translate(&RectI32::of(i32::MAX - 10, i32::MAX - 10, i32::MAX - 1, i32::MAX - 1), &PointI32::max()), RectI32::of(-12, -12, -3, -3));
    }
