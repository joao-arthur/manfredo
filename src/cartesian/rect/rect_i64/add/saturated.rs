...
mod tests {
    ...
    fn assign_add_big_rect_limits_out_of_bounds() {
        ...
        let mut r_min_x = RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1);
        assign_add(&mut r_min_x, &RectI64::of(i64::MIN, 0, 0, 0));
        assert_eq!(r_min_x, RectI64::of(i64::MIN, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1));

        let mut r_min_y = RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1);
        assign_add(&mut r_min_y, &RectI64::of(0, i64::MIN, 0, 0));
        assert_eq!(r_min_y, RectI64::of(i64::MIN + 1, i64::MIN, i64::MAX - 1, i64::MAX - 1));

        let mut r_max_x = RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1);
        assign_add(&mut r_max_x, &RectI64::of(0, 0, i64::MAX, 0));
        assert_eq!(r_max_x, RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX, i64::MAX - 1));

        let mut r_max_y = RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1);
        assign_add(&mut r_max_y, &RectI64::of(0, 0, 0, i64::MAX));
        assert_eq!(r_max_y, RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX));
    }
    ...
    fn add_small_rect_out_of_bounds() {
        assert_eq!(
            ...
            RectI64::of(i64::MIN, i64::MIN, i64::MIN + 20, i64::MIN + 30)
        );
        assert_eq!(
            add(&RectI64::of(i64::MAX - 20, i64::MAX - 30, i64::MAX - 5, i64::MAX - 10), &RectI64::of(0, 0, 20, 20)),
            RectI64::of(i64::MAX - 20, i64::MAX - 30, i64::MAX, i64::MAX)
        );
    }

    #[test]
    fn add_big_rect_out_of_bounds() {
        assert_eq!(add(&RectI64::of(i64::MIN + 10, i64::MIN + 5, i64::MAX, i64::MAX), &RectI64::of(-20, -20, 0, 0)), RectI64::largest());
        assert_eq!(add(&RectI64::of(i64::MIN, i64::MIN, i64::MAX - 5, i64::MAX - 10), &RectI64::of(0, 0, 20, 20)), RectI64::largest());
    }

    #[test]
    fn add_small_rect_limits_out_of_bounds() {
        assert_eq!(add(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MIN + 10, i64::MIN + 10), &RectI64::min()), RectI64::min());
        assert_eq!(add(&RectI64::of(i64::MAX - 10, i64::MAX - 10, i64::MAX - 1, i64::MAX - 1), &RectI64::max()), RectI64::max());
    }

    #[test]
    fn add_big_rect_limits_out_of_bounds() {
        assert_eq!(add(&RectI64::largest(), &RectI64::largest()), RectI64::largest());

        let r_large = RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1);
        assert_eq!(add(&r_large, &RectI64::largest()), RectI64::largest());
        assert_eq!(add(&r_large, &RectI64::of(i64::MIN, 0, 0, 0)), RectI64::of(i64::MIN, i64::MIN + 1, i64::MAX - 1, i64::MAX - 1));
        assert_eq!(add(&r_large, &RectI64::of(0, i64::MIN, 0, 0)), RectI64::of(i64::MIN + 1, i64::MIN, i64::MAX - 1, i64::MAX - 1));
        assert_eq!(add(&r_large, &RectI64::of(0, 0, i64::MAX, 0)), RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX, i64::MAX - 1));
        assert_eq!(add(&r_large, &RectI64::of(0, 0, 0, i64::MAX)), RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX - 1, i64::MAX));
    }
}
