...
fn try_saturating_inflate_to_bounds() {
    ...
    assert_eq!(
        try_saturating_inflate(&RectI64::of(i64::MIN + 1, i64::MIN + 10, i64::MAX - 10, i64::MAX - 10)),
        Some(RectI64::of(i64::MIN, i64::MIN + 9, i64::MAX - 9, i64::MAX - 9))
    );
    assert_eq!(
        try_saturating_inflate(&RectI64::of(i64::MIN + 10, i64::MIN + 1, i64::MAX - 10, i64::MAX - 10)),
        Some(RectI64::of(i64::MIN + 9, i64::MIN, i64::MAX - 9, i64::MAX - 9))
    );
    assert_eq!(
        try_saturating_inflate(&RectI64::of(i64::MIN + 10, i64::MIN + 10, i64::MAX - 1, i64::MAX - 10)),
        Some(RectI64::of(i64::MIN + 9, i64::MIN + 9, i64::MAX, i64::MAX - 9))
    );
    assert_eq!(
        try_saturating_inflate(&RectI64::of(i64::MIN + 10, i64::MIN + 10, i64::MAX - 10, i64::MAX - 1)),
