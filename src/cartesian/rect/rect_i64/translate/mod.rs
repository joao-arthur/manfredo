...
pub fn saturating_translate(r: &Rect, delta: &PointI64) -> Rect {
    ...
    Rect { min: PointI64 { x: min_x as i64, y: min_y as i64 }, max: PointI64 { x: max_x as i64, y: max_y as i64 } }
}
...
pub fn wrapping_translate(r: &Rect, delta: &PointI64) -> Rect {
    ...
    let max_x = min_x.wrapping_add_unsigned(dx);
    let max_y = min_y.wrapping_add_unsigned(dy);
    Rect { min: PointI64 { x: min_x, y: min_y }, max: PointI64 { x: max_x, y: max_y } }
}
