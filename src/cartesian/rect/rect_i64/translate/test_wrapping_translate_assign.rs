...
fn wrapping_translate_assign_to_bounds() {
    let mut min_r = RectI64::of(2, 5, i64::MAX, i64::MAX);
    wrapping_translate_assign(&mut min_r, &PointI64::of(-2, -5));
    assert_eq!(min_r, RectI64::of(0, 0, i64::MAX - 2, i64::MAX - 5));

    let mut max_r = RectI64::of(0, 0, i64::MAX - 2, i64::MAX - 5);
    wrapping_translate_assign(&mut max_r, &PointI64::of(2, 5));
    assert_eq!(max_r, RectI64::of(2, 5, i64::MAX, i64::MAX));
}

#[test]
fn wrapping_translate_assign_out_of_bounds() {
    let mut r1 = RectI64::of(10, 10, i64::MAX - 10, i64::MAX - 10);
    wrapping_translate_assign(&mut r1, &PointI64::of(-20, 0));
    assert_eq!(r1, RectI64::of(i64::MAX - 9, 10, i64::MAX - 30, i64::MAX - 10));

    let mut r2 = RectI64::of(10, 10, i64::MAX - 10, i64::MAX - 10);
    wrapping_translate_assign(&mut r2, &PointI64::of(0, -20));
    assert_eq!(r2, RectI64::of(10, i64::MAX - 9, i64::MAX - 10, i64::MAX - 30));

    let mut r3 = RectI64::of(10, 10, i64::MAX - 10, i64::MAX - 10);
    wrapping_translate_assign(&mut r3, &PointI64::of(20, 0));
    assert_eq!(r3, RectI64::of(30, 10, 9, i64::MAX - 10));

    let mut r4 = RectI64::of(10, 10, i64::MAX - 10, i64::MAX - 10);
    wrapping_translate_assign(&mut r4, &PointI64::of(0, 20));
    assert_eq!(r4, RectI64::of(10, 30, i64::MAX - 10, 9));
}
