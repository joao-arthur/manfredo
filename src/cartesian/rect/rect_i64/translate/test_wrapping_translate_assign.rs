...
fn out_of_bounds() {
    ...
    assert_eq!(r1, RectI64::of(MAX - 9, MIN + 10, MAX - 30, MAX - 10));

    let mut r2 = RectI64::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    wrapping_translate_assign(&mut r2, &PointI64::of(0, -20));
    assert_eq!(r2, RectI64::of(MIN + 10, MAX - 9, MAX - 10, MAX - 30));

    let mut r3 = RectI64::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    wrapping_translate_assign(&mut r3, &PointI64::of(20, 0));
    assert_eq!(r3, RectI64::of(MIN + 30, MIN + 10, MIN + 9, MAX - 10));

    let mut r4 = RectI64::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    wrapping_translate_assign(&mut r4, &PointI64::of(0, 20));
    assert_eq!(r4, RectI64::of(MIN + 10, MIN + 30, MAX - 10, MIN + 9));
}

#[test]
fn limits_out_of_bounds() {
    let mut r1 = RectI64::largest();
    wrapping_translate_assign(&mut r1, &PointI64::of(MIN, 0));
    assert_eq!(r1, RectI64::of(0, MIN, -1, MAX));

    let mut r2 = RectI64::largest();
    wrapping_translate_assign(&mut r2, &PointI64::of(0, MIN));
    assert_eq!(r2, RectI64::of(MIN, 0, MAX, -1));

    let mut r3 = RectI64::largest();
    wrapping_translate_assign(&mut r3, &PointI64::of(MAX, 0));
    assert_eq!(r3, RectI64::of(-1, MIN, -2, MAX));

    let mut r4 = RectI64::largest();
    wrapping_translate_assign(&mut r4, &PointI64::of(0, MAX));
    assert_eq!(r4, RectI64::of(MIN, -1, MAX, -2));
}
