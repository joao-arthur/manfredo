...
#[test]
fn to_bounds() {
    let mut r = RectI8::of(MIN + 2, MIN + 5, MAX - 2, MAX - 5);
...
fn edge_out_of_bounds() {
    ...
    assert_eq!(r1, RectI8::of(MAX, MIN, MAX, MAX));

    let mut r2 = RectI8::largest();
    wrapping_add_assign(&mut r2, &RectI8::of(0, -1, 0, 0));
    assert_eq!(r2, RectI8::of(MIN, MAX, MAX, MAX));

    let mut r3 = RectI8::largest();
    wrapping_add_assign(&mut r3, &RectI8::of(0, 0, 1, 0));
    assert_eq!(r3, RectI8::of(MIN, MIN, MIN, MAX));

    let mut r4 = RectI8::largest();
    wrapping_add_assign(&mut r4, &RectI8::of(0, 0, 0, 1));
    assert_eq!(r4, RectI8::of(MIN, MIN, MAX, MIN));
}

#[test]
fn limits_out_of_bounds() {
    let mut r1 = RectI8::largest();
    wrapping_add_assign(&mut r1, &RectI8::of(MIN, 0, 0, 0));
    assert_eq!(r1, RectI8::of(0, MIN, MAX, MAX));

    let mut r2 = RectI8::largest();
    wrapping_add_assign(&mut r2, &RectI8::of(0, MIN, 0, 0));
    assert_eq!(r2, RectI8::of(MIN, 0, MAX, MAX));

    let mut r3 = RectI8::largest();
    wrapping_add_assign(&mut r3, &RectI8::of(0, 0, MAX, 0));
    assert_eq!(r3, RectI8::of(MIN, MIN, -2, MAX));

    let mut r4 = RectI8::largest();
    wrapping_add_assign(&mut r4, &RectI8::of(0, 0, 0, MAX));
    assert_eq!(r4, RectI8::of(MIN, MIN, MAX, -2));
}
