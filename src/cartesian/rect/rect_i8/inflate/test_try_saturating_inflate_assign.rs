...
fn out_of_bounds() {
    ...
    let mut r_x = RectI8::of(i8::MIN, i8::MIN + 10, i8::MAX, i8::MAX - 10);
    assert_eq!(try_saturating_inflate_assign(&mut r_x), None);
    assert_eq!(r_x, RectI8::of(i8::MIN, i8::MIN + 10, i8::MAX, i8::MAX - 10));

    let mut r_y = RectI8::of(i8::MIN + 10, i8::MIN, i8::MAX - 10, i8::MAX);
    assert_eq!(try_saturating_inflate_assign(&mut r_y), None);
    assert_eq!(r_y, RectI8::of(i8::MIN + 10, i8::MIN, i8::MAX - 10, i8::MAX));
}
