...
#[test]
fn test() {
    assert_eq!(try_checked_translate(&Rect::of(5, 9, 13, 37), &PointI8::of(-10, -20)), Some(Rect::of(-5, -11, 3, 17)));
    assert_eq!(try_checked_translate(&Rect::of(-5, -11, 3, 17), &PointI8::of(6, -19)), Some(Rect::of(1, -30, 9, -2)));
}

#[test]
fn to_bounds() {
    assert_eq!(try_checked_translate(&Rect::of(MIN + 2, MIN + 5, MAX, MAX), &PointI8::of(-2, -5)), Some(Rect::of(MIN, MIN, MAX - 2, MAX - 5)));
    assert_eq!(try_checked_translate(&Rect::of(MIN, MIN, MAX - 2, MAX - 5), &PointI8::of(2, 5)), Some(Rect::of(MIN + 2, MIN + 5, MAX, MAX)));
}
