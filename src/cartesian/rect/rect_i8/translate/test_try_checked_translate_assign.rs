...
fn limits_out_of_bounds() {
    ...
    assert_eq!(try_checked_translate_assign(&mut r, &PointI8::of(MIN, 0)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &PointI8::of(0, MIN)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &PointI8::of(MAX, 0)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &PointI8::of(0, MAX)), None);
