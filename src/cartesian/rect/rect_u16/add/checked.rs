...
pub fn try_assign_add(r: &mut RectU16, delta: &RectI16) -> Option<()> {
...
mod tests {
    ...
    fn test_try_assign_add() {
        ...
        assert_eq!(try_assign_add(&mut r, &RectI16::of(-4, -3, -2, -1)), Some(()));
    ...
    fn try_assign_add_small_rect_to_bounds() {
        ...
        assert_eq!(min_r, RectU16::of(0, 0, 22, 35));
        ...
        assert_eq!(max_r, RectU16::of(u16::MAX - 13, u16::MAX - 19, u16::MAX, u16::MAX));
    }
    ...
    fn test_try_add() {
        let mut r = RectU16::of(0, 0, 12, 15);
        assert_eq!(try_add(&mut r, &RectI16::of(5, 4, 3, 2)), Some(RectU16::of(5, 4, 15, 17)));
        assert_eq!(try_add(&RectU16::of(5, 4, 15, 17), &RectI16::of(-4, -3, -2, -1)), Some(RectU16::of(1, 1, 13, 16)));
    }

    #[test]
    fn try_add_small_rect_to_bounds() {
        assert_eq!(try_add(&RectU16::of(2, 5, 12, 15), &RectI16::of(-2, -5, 10, 20)), Some(RectU16::of(0, 0, 22, 35)));
        assert_eq!(
            try_add(&RectU16::of(u16::MAX - 12, u16::MAX - 15, u16::MAX - 2, u16::MAX - 5), &RectI16::of(-1, -4, 2, 5)),
            Some(RectU16::of(u16::MAX - 13, u16::MAX - 19, u16::MAX, u16::MAX))
        );
    }
    ...
    fn try_add_small_rect_limits_out_of_bounds() {
        let r_min = RectU16::of(1, 1, 10, 10);
        ...
        let r_max = RectU16::of(u16::MAX - 10, u16::MAX - 10, u16::MAX - 1, u16::MAX - 1);
    ...
    fn try_add_big_rect_limits_out_of_bounds() {
        ...
        let r_min = RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1);
        ...
        let r_max = RectU16::of(1, 1, u16::MAX, u16::MAX);
    ...
    fn test_add() {
        let mut r = RectU16::of(0, 0, 12, 15);
        assert_eq!(add(&mut r, &RectI16::of(5, 4, 3, 2)), RectU16::of(5, 4, 15, 17));
