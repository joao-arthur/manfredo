...
fn limits_out_of_bounds() {
    let mut r = RectU16::largest();
    saturating_add_assign(&mut r, &Rect::of(i16::MIN, 0, 0, 0));
    assert_eq!(r, RectU16::largest());
    saturating_add_assign(&mut r, &Rect::of(0, i16::MIN, 0, 0));
    assert_eq!(r, RectU16::largest());
    saturating_add_assign(&mut r, &Rect::of(0, 0, i16::MAX, 0));
    assert_eq!(r, RectU16::largest());
    saturating_add_assign(&mut r, &Rect::of(0, 0, 0, i16::MAX));
    assert_eq!(r, RectU16::largest());
}
