...
#[test]
fn test() {
    assert_eq!(try_checked_add(&RectU16::of(0, 0, 12, 15), &RectI16::of(5, 4, 3, 2)), Some(RectU16::of(5, 4, 15, 17)));
    assert_eq!(try_checked_add(&RectU16::of(5, 4, 15, 20), &RectI16::of(-4, -3, -2, -1)), Some(RectU16::of(1, 1, 13, 19)));
}

#[test]
fn to_bounds() {
    assert_eq!(try_checked_add(&RectU16::of(2, 5, u16::MAX - 2, u16::MAX - 5), &RectI16::of(-2, -5, 2, 5)), Some(RectU16::largest()));
    assert_eq!(try_checked_add(&RectU16::of(2, 5, u16::MAX, u16::MAX), &RectI16::of(-2, -5, 0, 0)), Some(RectU16::largest()));
    assert_eq!(try_checked_add(&RectU16::of(0, 0, u16::MAX - 2, u16::MAX - 5), &RectI16::of(0, 0, 2, 5)), Some(RectU16::largest()));
}
