...
#[test]
fn to_bounds() {
    assert_eq!(try_checked_add(&RectU16::of(2, 5, MAX - 2, MAX - 5), &RectI16::of(-2, -5, 2, 5)), Some(RectU16::largest()));
    assert_eq!(try_checked_add(&RectU16::of(2, 5, MAX, MAX), &RectI16::of(-2, -5, 0, 0)), Some(RectU16::largest()));
    assert_eq!(try_checked_add(&RectU16::of(0, 0, MAX - 2, MAX - 5), &RectI16::of(0, 0, 2, 5)), Some(RectU16::largest()));
}
