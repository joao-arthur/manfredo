...
fn limits_out_of_bounds() {
    let mut r = RectU16::largest();
    assert_eq!(try_checked_add_assign(&mut r, &RectI::of(i16::MIN, 0, 0, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI::of(0, i16::MIN, 0, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI::of(0, 0, i16::MAX, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI::of(0, 0, 0, i16::MAX)), None);
    assert_eq!(r, RectU16::largest());
}
