...
mod tests {
    ...
    fn try_assign_inflate_out_of_bounds() {
        let mut r_min_x = RectU16::of(0, 10, u16::MAX, 20);
        assert_eq!(try_assign_inflate(&mut r_min_x), None);
        assert_eq!(r_min_x, RectU16::of(0, 10, u16::MAX, 20));

        let mut r_max_x = RectU16::of(10, 10, u16::MAX, 20);
        assert_eq!(try_assign_inflate(&mut r_max_x), None);
        assert_eq!(r_max_x, RectU16::of(10, 10, u16::MAX, 20));

        let mut r_min_y = RectU16::of(10, 0, 20, 20);
        assert_eq!(try_assign_inflate(&mut r_min_y), None);
        assert_eq!(r_min_y, RectU16::of(10, 0, 20, 20));

        let mut r_max_y = RectU16::of(10, 10, 20, u16::MAX);
        assert_eq!(try_assign_inflate(&mut r_max_y), None);
        assert_eq!(r_max_y, RectU16::of(10, 10, 20, u16::MAX));
    ...
    fn try_inflate_min_bounds() {
        assert_eq!(try_inflate(&RectU16::of(7, 3, 9, 13)), Some(RectU16::of(6, 2, 10, 14)));
        assert_eq!(try_inflate(&RectU16::of(6, 2, 10, 14)), Some(RectU16::of(5, 1, 11, 15)));
        assert_eq!(try_inflate(&RectU16::of(5, 1, 11, 15)), Some(RectU16::of(4, 0, 12, 16)));
    }

    #[test]
    fn try_inflate_max_bounds() {
        assert_eq!(try_inflate(&RectU16::of(u16::MAX - 33, u16::MAX - 17, u16::MAX - 5, u16::MAX - 3)), Some(RectU16::of(u16::MAX - 34, u16::MAX - 18, u16::MAX - 4, u16::MAX - 2)));
        assert_eq!(try_inflate(&RectU16::of(u16::MAX - 34, u16::MAX - 18, u16::MAX - 4, u16::MAX - 2)), Some(RectU16::of(u16::MAX - 35, u16::MAX - 19, u16::MAX - 3, u16::MAX - 1)));
        assert_eq!(try_inflate(&RectU16::of(u16::MAX - 35, u16::MAX - 19, u16::MAX - 3, u16::MAX - 1)), Some(RectU16::of(u16::MAX - 36, u16::MAX - 20, u16::MAX - 2, u16::MAX)));
    }
    ...
    fn try_inflate_out_of_bounds() {
        ...
        assert_eq!(try_inflate(&RectU16::of(10, 10, u16::MAX, 20)), None);
        assert_eq!(try_inflate(&RectU16::of(10, 0, 20, 20)), None);
        assert_eq!(try_inflate(&RectU16::of(10, 10, 20, u16::MAX)), None);
    ...
    fn inflate_min_bounds() {
        assert_eq!(inflate(&RectU16::of(7, 3, 9, 13)), RectU16::of(6, 2, 10, 14));
        assert_eq!(inflate(&RectU16::of(6, 2, 10, 14)), RectU16::of(5, 1, 11, 15));
        assert_eq!(inflate(&RectU16::of(5, 1, 11, 15)), RectU16::of(4, 0, 12, 16));
    }

    #[test]
    fn inflate_max_bounds() {
        assert_eq!(inflate(&RectU16::of(u16::MAX - 33, u16::MAX - 17, u16::MAX - 5, u16::MAX - 3)), RectU16::of(u16::MAX - 34, u16::MAX - 18, u16::MAX - 4, u16::MAX - 2));
        assert_eq!(inflate(&RectU16::of(u16::MAX - 34, u16::MAX - 18, u16::MAX - 4, u16::MAX - 2)), RectU16::of(u16::MAX - 35, u16::MAX - 19, u16::MAX - 3, u16::MAX - 1));
        assert_eq!(inflate(&RectU16::of(u16::MAX - 35, u16::MAX - 19, u16::MAX - 3, u16::MAX - 1)), RectU16::of(u16::MAX - 36, u16::MAX - 20, u16::MAX - 2, u16::MAX));
    }
}
