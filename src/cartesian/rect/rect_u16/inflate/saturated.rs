...
pub fn try_assign_inflate_in_bounds(r: &mut RectU16) -> Option<()> {
...
pub fn try_inflate_in_bounds(r: &RectU16) -> Option<RectU16> {
    let is_min_x = r.min.x == 0;
    let is_min_y = r.min.y == 0;
    let is_max_x = r.max.x == u16::MAX;
    let is_max_y = r.max.y == u16::MAX;
...
pub fn assign_inflate_in_bounds(r: &mut RectU16) {
    try_assign_inflate_in_bounds(r).unwrap()
}

pub fn inflate_in_bounds(r: &RectU16) -> RectU16 {
    try_inflate_in_bounds(r).unwrap()
}

#[cfg(test)]
mod tests {
    use super::{RectU16, assign_inflate_in_bounds, inflate_in_bounds, try_assign_inflate_in_bounds, try_inflate_in_bounds};
    ...
    fn try_inflate_in_bounds_min_bounds() {
        assert_eq!(try_inflate_in_bounds(&RectU16::of(7, 2, 4, 13)), Some(RectU16::of(6, 1, 5, 14)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(6, 1, 5, 14)), Some(RectU16::of(5, 0, 6, 15)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(5, 0, 6, 15)), Some(RectU16::of(4, 0, 7, 17)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(4, 0, 7, 17)), Some(RectU16::of(3, 0, 8, 19)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(3, 0, 8, 19)), Some(RectU16::of(2, 0, 9, 21)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(2, 0, 9, 21)), Some(RectU16::of(1, 0, 10, 23)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(1, 0, 10, 23)), Some(RectU16::of(0, 0, 11, 25)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(0, 0, 11, 25)), Some(RectU16::of(0, 0, 13, 27)));
    }
    ...
    fn try_inflate_in_bounds_max_bounds() {
        ...
        assert_eq!(try_inflate_in_bounds(&RectU16::of(195, 223, u16::MAX, u16::MAX)), Some(RectU16::of(193, 221, u16::MAX, u16::MAX)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(193, 221, u16::MAX, u16::MAX)), Some(RectU16::of(191, 219, u16::MAX, u16::MAX)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(191, 219, u16::MAX, u16::MAX)), Some(RectU16::of(189, 217, u16::MAX, u16::MAX)));
    }

    #[test]
    fn try_inflate_in_bounds_to_bounds() {
        assert_eq!(try_inflate_in_bounds(&RectU16::of(1, 1, u16::MAX - 1, u16::MAX - 1)), Some(RectU16::of(0, 0, u16::MAX, u16::MAX)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1)), Some(RectU16::of(0, 0, u16::MAX, u16::MAX)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(1, 1, u16::MAX, u16::MAX)), Some(RectU16::of(0, 0, u16::MAX, u16::MAX)));
    }

    #[test]
    fn try_inflate_in_bounds_width_to_bounds() {
        assert_eq!(try_inflate_in_bounds(&RectU16::of(1, 10, 100, 100)), Some(RectU16::of(0, 9, 101, 101)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(10, 10, u16::MAX - 1, 100)), Some(RectU16::of(9, 9, u16::MAX, 101)));
    }

    #[test]
    fn try_inflate_in_bounds_height_to_bounds() {
        assert_eq!(try_inflate_in_bounds(&RectU16::of(10, 1, 100, 100)), Some(RectU16::of(9, 0, 101, 101)));
        assert_eq!(try_inflate_in_bounds(&RectU16::of(10, 10, 100, u16::MAX - 1)), Some(RectU16::of(9, 9, 101, u16::MAX)));
    }

    #[test]
    fn try_inflate_in_bounds_out_of_bounds() {
        assert_eq!(try_inflate_in_bounds(&RectU16::of(0, 0, u16::MAX, u16::MAX)), None);
        assert_eq!(try_inflate_in_bounds(&RectU16::of(0, 10, u16::MAX, 100)), None);
        assert_eq!(try_inflate_in_bounds(&RectU16::of(10, 0, 100, u16::MAX)), None);
    }
    ...
    fn inflate_in_bounds_min_bounds() {
        assert_eq!(inflate_in_bounds(&RectU16::of(7, 2, 4, 13)), RectU16::of(6, 1, 5, 14));
        assert_eq!(inflate_in_bounds(&RectU16::of(6, 1, 5, 14)), RectU16::of(5, 0, 6, 15));
        assert_eq!(inflate_in_bounds(&RectU16::of(5, 0, 6, 15)), RectU16::of(4, 0, 7, 17));
        assert_eq!(inflate_in_bounds(&RectU16::of(4, 0, 7, 17)), RectU16::of(3, 0, 8, 19));
        assert_eq!(inflate_in_bounds(&RectU16::of(3, 0, 8, 19)), RectU16::of(2, 0, 9, 21));
        assert_eq!(inflate_in_bounds(&RectU16::of(2, 0, 9, 21)), RectU16::of(1, 0, 10, 23));
        assert_eq!(inflate_in_bounds(&RectU16::of(1, 0, 10, 23)), RectU16::of(0, 0, 11, 25));
        assert_eq!(inflate_in_bounds(&RectU16::of(0, 0, 11, 25)), RectU16::of(0, 0, 13, 27));
    }

    #[test]
    fn inflate_in_bounds_max_bounds() {
        assert_eq!(inflate_in_bounds(&RectU16::of(200, 230, u16::MAX - 5, u16::MAX - 3)), RectU16::of(199, 229, u16::MAX - 4, u16::MAX - 2));
        assert_eq!(inflate_in_bounds(&RectU16::of(199, 229, u16::MAX - 4, u16::MAX - 2)), RectU16::of(198, 228, u16::MAX - 3, u16::MAX - 1));
        assert_eq!(inflate_in_bounds(&RectU16::of(198, 228, u16::MAX - 3, u16::MAX - 1)), RectU16::of(197, 227, u16::MAX - 2, u16::MAX));
        assert_eq!(inflate_in_bounds(&RectU16::of(197, 227, u16::MAX - 2, u16::MAX)), RectU16::of(196, 225, u16::MAX - 1, u16::MAX));
        assert_eq!(inflate_in_bounds(&RectU16::of(196, 225, u16::MAX - 1, u16::MAX)), RectU16::of(195, 223, u16::MAX, u16::MAX));
        assert_eq!(inflate_in_bounds(&RectU16::of(195, 223, u16::MAX, u16::MAX)), RectU16::of(193, 221, u16::MAX, u16::MAX));
        assert_eq!(inflate_in_bounds(&RectU16::of(193, 221, u16::MAX, u16::MAX)), RectU16::of(191, 219, u16::MAX, u16::MAX));
        assert_eq!(inflate_in_bounds(&RectU16::of(191, 219, u16::MAX, u16::MAX)), RectU16::of(189, 217, u16::MAX, u16::MAX));
    }
}
