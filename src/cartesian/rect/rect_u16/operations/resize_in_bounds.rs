...
pub fn try_assign_resize_in_bounds(r: &mut RectU16, size: u16) -> Option<()> {
    if size < 3 {
        return None;
    }
...
pub fn try_resize_in_bounds(r: &RectU16, size: u16) -> Option<RectU16> {
    if size < 3 {
        return None;
    }
    let diff_x = i32::from(delta_x(r)) + 1 - i32::from(size);
...
pub fn assign_resize_in_bounds(r: &mut RectU16, size: u16) {
    try_assign_resize_in_bounds(r, size).unwrap()
}

pub fn resize_in_bounds(r: &RectU16, size: u16) -> RectU16 {
    try_resize_in_bounds(r, size).unwrap()
}

#[cfg(test)]
mod tests {
    use super::{RectU16, assign_resize_in_bounds, resize_in_bounds, try_assign_resize_in_bounds, try_resize_in_bounds};
    ...
    fn try_assign_resize_in_bounds_odd_small_rect_limits_out_of_bounds() {
        let mut r_min = RectU16::of(0, 0, 2, 2);
        assert_eq!(try_assign_resize_in_bounds(&mut r_min, u16::MAX), Some(()));
        assert_eq!(r_min, RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1));

        let mut r_max = RectU16::of(u16::MAX - 2, u16::MAX - 2, u16::MAX, u16::MAX);
        assert_eq!(try_assign_resize_in_bounds(&mut r_max, u16::MAX), Some(()));
    ...
    fn try_assign_resize_in_bounds_even_small_rect_limits_out_of_bounds() {
        let mut r = RectU16::of(0, 0, 3, 3);
        assert_eq!(try_assign_resize_in_bounds(&mut r, u16::MAX - 1), Some(()));
    ...
    fn try_assign_resize_in_bounds_big_rect_limits_out_of_bounds() {
        ...
        assert_eq!(try_assign_resize_in_bounds(&mut r_odd_1, u16::MAX), Some(()));
        ...
        assert_eq!(try_assign_resize_in_bounds(&mut r_even, u16::MAX), Some(()));
        assert_eq!(r_even, RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1));
    }

    #[test]
    fn try_resize_in_bounds_odd() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(5, 5, 15, 15), 11), Some(RectU16::of(5, 5, 15, 15)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(5, 5, 15, 15), 9), Some(RectU16::of(6, 6, 14, 14)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(6, 6, 14, 14), 7), Some(RectU16::of(7, 7, 13, 13)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(7, 7, 13, 13), 5), Some(RectU16::of(8, 8, 12, 12)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(8, 8, 12, 12), 3), Some(RectU16::of(9, 9, 11, 11)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(9, 9, 11, 11), 9), Some(RectU16::of(6, 6, 14, 14)));
    }

    #[test]
    fn try_resize_in_bounds_even() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(5, 5, 14, 14), 10), Some(RectU16::of(5, 5, 14, 14)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(5, 5, 14, 14), 8), Some(RectU16::of(6, 6, 13, 13)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(6, 6, 13, 13), 6), Some(RectU16::of(7, 7, 12, 12)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(7, 7, 12, 12), 4), Some(RectU16::of(8, 8, 11, 11)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(8, 8, 11, 11), 8), Some(RectU16::of(6, 6, 13, 13)));
    }

    #[test]
    fn try_resize_in_bounds_small_size() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(10, 10, 100, 100), 0), None);
        assert_eq!(try_resize_in_bounds(&RectU16::of(10, 10, 100, 100), 1), None);
        assert_eq!(try_resize_in_bounds(&RectU16::of(10, 10, 100, 100), 2), None);
    }

    #[test]
    fn try_resize_in_bounds_same_size() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(10, 10, 20, 20), 11), Some(RectU16::of(10, 10, 20, 20)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(10, 10, 21, 21), 12), Some(RectU16::of(10, 10, 21, 21)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(9, 9, 21, 21), 13), Some(RectU16::of(9, 9, 21, 21)));
    }

    #[test]
    fn try_resize_in_bounds_odd_small_rect_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(0, 0, 2, 2), 11), Some(RectU16::of(0, 0, 10, 10)));
        assert_eq!(
            try_resize_in_bounds(&RectU16::of(u16::MAX - 2, u16::MAX - 2, u16::MAX, u16::MAX), 11),
    ...
    fn try_resize_in_bounds_even_small_rect_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(0, 0, 3, 3), 11), Some(RectU16::of(0, 0, 10, 10)));
        assert_eq!(
            try_resize_in_bounds(&RectU16::of(u16::MAX - 3, u16::MAX - 3, u16::MAX, u16::MAX), 11),
            Some(RectU16::of(u16::MAX - 10, u16::MAX - 10, u16::MAX, u16::MAX))
        );
    }
    ...
    fn try_resize_in_bounds_odd_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(0, 0, 2, 2), u16::MAX), Some(RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(u16::MAX - 2, u16::MAX - 2, u16::MAX, u16::MAX), u16::MAX), Some(RectU16::of(1, 1, u16::MAX, u16::MAX)));
    }

    #[test]
    fn try_resize_in_bounds_even_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(0, 0, 3, 3), u16::MAX - 1), Some(RectU16::of(0, 0, u16::MAX - 2, u16::MAX - 2)));
        assert_eq!(
            try_resize_in_bounds(&RectU16::of(u16::MAX - 3, u16::MAX - 3, u16::MAX, u16::MAX), u16::MAX - 1),
    ...
    fn try_resize_in_bounds_big_rect_limits_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1), u16::MAX), Some(RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(1, 1, u16::MAX, u16::MAX), u16::MAX), Some(RectU16::of(1, 1, u16::MAX, u16::MAX)));
        assert_eq!(try_resize_in_bounds(&RectU16::of(0, 0, u16::MAX, u16::MAX), u16::MAX), Some(RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1)));
    }
    ...
    fn resize_in_bounds_odd() {
        assert_eq!(resize_in_bounds(&RectU16::of(5, 5, 15, 15), 11), RectU16::of(5, 5, 15, 15));
        assert_eq!(resize_in_bounds(&RectU16::of(5, 5, 15, 15), 9), RectU16::of(6, 6, 14, 14));
        assert_eq!(resize_in_bounds(&RectU16::of(6, 6, 14, 14), 7), RectU16::of(7, 7, 13, 13));
        assert_eq!(resize_in_bounds(&RectU16::of(7, 7, 13, 13), 5), RectU16::of(8, 8, 12, 12));
        assert_eq!(resize_in_bounds(&RectU16::of(8, 8, 12, 12), 3), RectU16::of(9, 9, 11, 11));
        assert_eq!(resize_in_bounds(&RectU16::of(9, 9, 11, 11), 9), RectU16::of(6, 6, 14, 14));
    }

    #[test]
    fn resize_in_bounds_even() {
        assert_eq!(resize_in_bounds(&RectU16::of(5, 5, 14, 14), 10), RectU16::of(5, 5, 14, 14));
        assert_eq!(resize_in_bounds(&RectU16::of(5, 5, 14, 14), 8), RectU16::of(6, 6, 13, 13));
        assert_eq!(resize_in_bounds(&RectU16::of(6, 6, 13, 13), 6), RectU16::of(7, 7, 12, 12));
        assert_eq!(resize_in_bounds(&RectU16::of(7, 7, 12, 12), 4), RectU16::of(8, 8, 11, 11));
        assert_eq!(resize_in_bounds(&RectU16::of(8, 8, 11, 11), 8), RectU16::of(6, 6, 13, 13));
    }
}
