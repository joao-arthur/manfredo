...
fn wrapping_resize_odd() {
    ...
    assert_eq!(wrapping_resize(&RectU16::of(8, 8, 12, 12), 3), RectU16::of(9, 9, 11, 11));
    assert_eq!(wrapping_resize(&RectU16::of(9, 9, 11, 11), 9), RectU16::of(6, 6, 14, 14));
}
...
fn wrapping_resize_even() {
    ...
    assert_eq!(wrapping_resize(&RectU16::of(7, 7, 12, 12), 4), RectU16::of(8, 8, 11, 11));
    assert_eq!(wrapping_resize(&RectU16::of(8, 8, 11, 11), 8), RectU16::of(6, 6, 13, 13));
}
