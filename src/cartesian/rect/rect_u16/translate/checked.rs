...
pub fn try_assign_translate(r: &mut RectU16, delta: &PointI16) -> Option<()> {
...
pub fn try_translate(r: &RectU16, delta: &PointI16) -> Option<RectU16> {
    let min_x = r.min.x.checked_add_signed(delta.x)?;
    let min_y = r.min.y.checked_add_signed(delta.y)?;
    let max_x = r.max.x.checked_add_signed(delta.x)?;
    let max_y = r.max.y.checked_add_signed(delta.y)?;
...
mod tests {
    ...
    fn test_try_assign_translate() {
        ...
        assert_eq!(try_assign_translate(&mut r, &PointI16::of(5, 4)), Some(()));
        assert_eq!(r, RectU16::of(5, 4, 17, 19));
        assert_eq!(try_assign_translate(&mut r, &PointI16::of(-4, -2)), Some(()));
    ...
    fn test_try_translate() {
        assert_eq!(try_translate(&RectU16::of(0, 0, 12, 15), &PointI16::of(5, 4)), Some(RectU16::of(5, 4, 17, 19)));
        assert_eq!(try_translate(&RectU16::of(5, 4, 17, 19), &PointI16::of(-4, -2)), Some(RectU16::of(1, 2, 13, 17)));
    }

    #[test]
    fn try_translate_small_rect_to_bounds() {
        assert_eq!(try_translate(&RectU16::of(2, 5, 12, 15), &PointI16::of(-2, -5)), Some(RectU16::of(0, 0, 10, 10)));
        assert_eq!(
            try_translate(&RectU16::of(u16::MAX - 12, u16::MAX - 15, u16::MAX - 2, u16::MAX - 5), &PointI16::of(2, 5)),
    ...
    fn try_translate_big_rect_to_bounds() {
        assert_eq!(try_translate(&RectU16::of(2, 5, u16::MAX, u16::MAX), &PointI16::of(-2, -5)), Some(RectU16::of(0, 0, u16::MAX - 2, u16::MAX - 5)));
        assert_eq!(try_translate(&RectU16::of(0, 0, u16::MAX - 2, u16::MAX - 5), &PointI16::of(2, 5)), Some(RectU16::of(2, 5, u16::MAX, u16::MAX)));
    }

    #[test]
    fn try_translate_small_rect_out_of_bounds() {
        assert_eq!(try_translate(&RectU16::of(10, 5, 20, 30), &PointI16::of(-20, -20)), None);
        assert_eq!(try_translate(&RectU16::of(u16::MAX - 20, u16::MAX - 30, u16::MAX - 5, u16::MAX - 10), &PointI16::of(20, 20)), None);
    }

    #[test]
    fn try_translate_big_rect_out_of_bounds() {
        assert_eq!(try_translate(&RectU16::of(10, 5, u16::MAX, u16::MAX), &PointI16::of(-20, -20)), None);
        assert_eq!(try_translate(&RectU16::of(0, 0, u16::MAX - 5, u16::MAX - 10), &PointI16::of(20, 20)), None);
    }

    #[test]
    fn try_translate_small_rect_limits_out_of_bounds() {
        assert_eq!(try_translate(&RectU16::of(1, 1, 10, 10), &PointI16::min()), None);
        assert_eq!(try_translate(&RectU16::of(1, 1, 10, 10), &PointI16::of(i16::MIN, 0)), None);
        assert_eq!(try_translate(&RectU16::of(1, 1, 10, 10), &PointI16::of(0, i16::MIN)), None);
        assert_eq!(try_translate(&RectU16::of(u16::MAX - 10, u16::MAX - 10, u16::MAX - 1, u16::MAX - 1), &PointI16::max()), None);
        assert_eq!(try_translate(&RectU16::of(u16::MAX - 10, u16::MAX - 10, u16::MAX - 1, u16::MAX - 1), &PointI16::of(i16::MAX, 0)), None);
        assert_eq!(try_translate(&RectU16::of(u16::MAX - 10, u16::MAX - 10, u16::MAX - 1, u16::MAX - 1), &PointI16::of(0, i16::MAX)), None);
    }

    #[test]
    fn try_translate_big_rect_limits_out_of_bounds() {
        assert_eq!(try_translate(&RectU16::largest(), &PointI16::min()), None);
        assert_eq!(try_translate(&RectU16::largest(), &PointI16::max()), None);
        assert_eq!(try_translate(&RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1), &PointI16::max()), None);
        assert_eq!(try_translate(&RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1), &PointI16::of(i16::MAX, 0)), None);
        assert_eq!(try_translate(&RectU16::of(0, 0, u16::MAX - 1, u16::MAX - 1), &PointI16::of(0, i16::MAX)), None);
        assert_eq!(try_translate(&RectU16::of(1, 1, u16::MAX, u16::MAX), &PointI16::min()), None);
        assert_eq!(try_translate(&RectU16::of(1, 1, u16::MAX, u16::MAX), &PointI16::of(i16::MIN, 0)), None);
        assert_eq!(try_translate(&RectU16::of(1, 1, u16::MAX, u16::MAX), &PointI16::of(0, i16::MIN)), None);
    }
