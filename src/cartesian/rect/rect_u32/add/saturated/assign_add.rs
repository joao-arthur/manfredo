...
mod tests {
    ...
    fn assign_add_big_rect_limits_out_of_bounds() {
        ...
        let mut r_min_x = RectU32::of(1, 1, u32::MAX - 1, u32::MAX - 1);
        assign_add(&mut r_min_x, &RectI32::of(i32::MIN, 0, 0, 0));
        assert_eq!(r_min_x, RectU32::of(0, 1, u32::MAX - 1, u32::MAX - 1));

        let mut r_min_y = RectU32::of(1, 1, u32::MAX - 1, u32::MAX - 1);
        assign_add(&mut r_min_y, &RectI32::of(0, i32::MIN, 0, 0));
        assert_eq!(r_min_y, RectU32::of(1, 0, u32::MAX - 1, u32::MAX - 1));

        let mut r_max_x = RectU32::of(1, 1, u32::MAX - 1, u32::MAX - 1);
        assign_add(&mut r_max_x, &RectI32::of(0, 0, i32::MAX, 0));
        assert_eq!(r_max_x, RectU32::of(1, 1, u32::MAX, u32::MAX - 1));

        let mut r_max_y = RectU32::of(1, 1, u32::MAX - 1, u32::MAX - 1);
        assign_add(&mut r_max_y, &RectI32::of(0, 0, 0, i32::MAX));
        assert_eq!(r_max_y, RectU32::of(1, 1, u32::MAX - 1, u32::MAX));
    }
}
