...
#[test]
fn to_bounds() {
    assert_eq!(saturating_add(&RectU32::of(2, 5, MAX - 2, MAX - 5), &RectI32::of(-2, -5, 2, 5)), RectU32::largest());
    assert_eq!(saturating_add(&RectU32::of(2, 5, MAX, MAX), &RectI32::of(-2, -5, 0, 0)), RectU32::largest());
    assert_eq!(saturating_add(&RectU32::of(0, 0, MAX - 2, MAX - 5), &RectI32::of(0, 0, 2, 5)), RectU32::largest());
}

#[test]
fn out_of_bounds() {
    let r = RectU32::of(10, 10, MAX - 10, MAX - 10);
    assert_eq!(saturating_add(&r, &RectI32::of(-20, 0, 0, 0)), RectU32::of(0, 10, MAX - 10, MAX - 10));
    assert_eq!(saturating_add(&r, &RectI32::of(0, -20, 0, 0)), RectU32::of(10, 0, MAX - 10, MAX - 10));
    assert_eq!(saturating_add(&r, &RectI32::of(0, 0, 20, 0)), RectU32::of(10, 10, MAX, MAX - 10));
    assert_eq!(saturating_add(&r, &RectI32::of(0, 0, 0, 20)), RectU32::of(10, 10, MAX - 10, MAX));
}
