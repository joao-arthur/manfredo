...
fn edge_out_of_bounds() {
    ...
    assert_eq!(r1, RectU32::of(MAX, 0, MAX, MAX));

    let mut r2 = RectU32::largest();
    wrapping_add_assign(&mut r2, &RectI::of(0, -1, 0, 0));
    assert_eq!(r2, RectU32::of(0, MAX, MAX, MAX));

    let mut r3 = RectU32::largest();
    wrapping_add_assign(&mut r3, &RectI::of(0, 0, 1, 0));
    assert_eq!(r3, RectU32::of(0, 0, 0, MAX));

    let mut r4 = RectU32::largest();
    wrapping_add_assign(&mut r4, &RectI::of(0, 0, 0, 1));
    assert_eq!(r4, RectU32::of(0, 0, MAX, 0));
}

#[test]
fn limits_out_of_bounds() {
    let mut r1 = RectU32::largest();
    wrapping_add_assign(&mut r1, &RectI::of(i32::MIN, 0, 0, 0));
    assert_eq!(r1, RectU32::of(MAX / 2 + 1, 0, MAX, MAX));

    let mut r2 = RectU32::largest();
    wrapping_add_assign(&mut r2, &RectI::of(0, i32::MIN, 0, 0));
    assert_eq!(r2, RectU32::of(0, MAX / 2 + 1, MAX, MAX));

    let mut r3 = RectU32::largest();
    wrapping_add_assign(&mut r3, &RectI::of(0, 0, i32::MAX, 0));
    assert_eq!(r3, RectU32::of(0, 0, MAX / 2 - 1, MAX));

    let mut r4 = RectU32::largest();
    wrapping_add_assign(&mut r4, &RectI::of(0, 0, 0, i32::MAX));
    assert_eq!(r4, RectU32::of(0, 0, MAX, MAX / 2 - 1));
}
