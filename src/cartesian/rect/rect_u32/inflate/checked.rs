...
mod tests {
    ...
    fn try_inflate_min_bounds() {
        assert_eq!(try_inflate(&RectU32::of(7, 3, 9, 13)), Some(RectU32::of(6, 2, 10, 14)));
        assert_eq!(try_inflate(&RectU32::of(6, 2, 10, 14)), Some(RectU32::of(5, 1, 11, 15)));
        assert_eq!(try_inflate(&RectU32::of(5, 1, 11, 15)), Some(RectU32::of(4, 0, 12, 16)));
    }

    #[test]
    fn try_inflate_max_bounds() {
        assert_eq!(try_inflate(&RectU32::of(u32::MAX - 33, u32::MAX - 17, u32::MAX - 5, u32::MAX - 3)), Some(RectU32::of(u32::MAX - 34, u32::MAX - 18, u32::MAX - 4, u32::MAX - 2)));
        assert_eq!(try_inflate(&RectU32::of(u32::MAX - 34, u32::MAX - 18, u32::MAX - 4, u32::MAX - 2)), Some(RectU32::of(u32::MAX - 35, u32::MAX - 19, u32::MAX - 3, u32::MAX - 1)));
        assert_eq!(try_inflate(&RectU32::of(u32::MAX - 35, u32::MAX - 19, u32::MAX - 3, u32::MAX - 1)), Some(RectU32::of(u32::MAX - 36, u32::MAX - 20, u32::MAX - 2, u32::MAX)));
    }
    ...
    fn try_inflate_out_of_bounds() {
        ...
        assert_eq!(try_inflate(&RectU32::of(10, 10, u32::MAX, 20)), None);
        assert_eq!(try_inflate(&RectU32::of(10, 0, 20, 20)), None);
        assert_eq!(try_inflate(&RectU32::of(10, 10, 20, u32::MAX)), None);
    ...
    fn inflate_min_bounds() {
        assert_eq!(inflate(&RectU32::of(7, 3, 9, 13)), RectU32::of(6, 2, 10, 14));
        assert_eq!(inflate(&RectU32::of(6, 2, 10, 14)), RectU32::of(5, 1, 11, 15));
        assert_eq!(inflate(&RectU32::of(5, 1, 11, 15)), RectU32::of(4, 0, 12, 16));
    }

    #[test]
    fn inflate_max_bounds() {
        assert_eq!(inflate(&RectU32::of(u32::MAX - 33, u32::MAX - 17, u32::MAX - 5, u32::MAX - 3)), RectU32::of(u32::MAX - 34, u32::MAX - 18, u32::MAX - 4, u32::MAX - 2));
        assert_eq!(inflate(&RectU32::of(u32::MAX - 34, u32::MAX - 18, u32::MAX - 4, u32::MAX - 2)), RectU32::of(u32::MAX - 35, u32::MAX - 19, u32::MAX - 3, u32::MAX - 1));
        assert_eq!(inflate(&RectU32::of(u32::MAX - 35, u32::MAX - 19, u32::MAX - 3, u32::MAX - 1)), RectU32::of(u32::MAX - 36, u32::MAX - 20, u32::MAX - 2, u32::MAX));
    }
}
