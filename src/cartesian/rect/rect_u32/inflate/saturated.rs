...
mod tests {
    ...
    fn try_inflate_min_bounds() {
        assert_eq!(try_inflate(&RectU32::of(7, 2, 4, 13)), Some(RectU32::of(6, 1, 5, 14)));
        assert_eq!(try_inflate(&RectU32::of(6, 1, 5, 14)), Some(RectU32::of(5, 0, 6, 15)));
        assert_eq!(try_inflate(&RectU32::of(5, 0, 6, 15)), Some(RectU32::of(4, 0, 7, 17)));
        assert_eq!(try_inflate(&RectU32::of(4, 0, 7, 17)), Some(RectU32::of(3, 0, 8, 19)));
        assert_eq!(try_inflate(&RectU32::of(3, 0, 8, 19)), Some(RectU32::of(2, 0, 9, 21)));
        assert_eq!(try_inflate(&RectU32::of(2, 0, 9, 21)), Some(RectU32::of(1, 0, 10, 23)));
        assert_eq!(try_inflate(&RectU32::of(1, 0, 10, 23)), Some(RectU32::of(0, 0, 11, 25)));
        assert_eq!(try_inflate(&RectU32::of(0, 0, 11, 25)), Some(RectU32::of(0, 0, 13, 27)));
    }
    ...
    fn inflate_min_bounds() {
        assert_eq!(inflate(&RectU32::of(7, 2, 4, 13)), RectU32::of(6, 1, 5, 14));
        assert_eq!(inflate(&RectU32::of(6, 1, 5, 14)), RectU32::of(5, 0, 6, 15));
        assert_eq!(inflate(&RectU32::of(5, 0, 6, 15)), RectU32::of(4, 0, 7, 17));
        assert_eq!(inflate(&RectU32::of(4, 0, 7, 17)), RectU32::of(3, 0, 8, 19));
        assert_eq!(inflate(&RectU32::of(3, 0, 8, 19)), RectU32::of(2, 0, 9, 21));
        assert_eq!(inflate(&RectU32::of(2, 0, 9, 21)), RectU32::of(1, 0, 10, 23));
        assert_eq!(inflate(&RectU32::of(1, 0, 10, 23)), RectU32::of(0, 0, 11, 25));
        assert_eq!(inflate(&RectU32::of(0, 0, 11, 25)), RectU32::of(0, 0, 13, 27));
    }
