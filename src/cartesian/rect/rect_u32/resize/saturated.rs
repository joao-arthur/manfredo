...
#[cfg(test)]
mod tests {
    use super::{RectU32, assign_resize, resize, try_assign_resize, try_resize};
    ...
    fn try_resize_small_size() {
        assert_eq!(try_resize(&RectU32::of(10, 10, 100, 100), 0), None);
        assert_eq!(try_resize(&RectU32::of(10, 10, 100, 100), 1), None);
        assert_eq!(try_resize(&RectU32::of(10, 10, 100, 100), 2), None);
    }
    ...
    fn try_resize_odd_small_rect_out_of_bounds() {
        assert_eq!(try_resize(&RectU32::of(0, 0, 2, 2), 11), Some(RectU32::of(0, 0, 10, 10)));
        assert_eq!(
            try_resize(&RectU32::of(u32::MAX - 2, u32::MAX - 2, u32::MAX, u32::MAX), 11),
    ...
    fn try_resize_even_small_rect_out_of_bounds() {
        assert_eq!(try_resize(&RectU32::of(0, 0, 3, 3), 11), Some(RectU32::of(0, 0, 10, 10)));
        assert_eq!(
            try_resize(&RectU32::of(u32::MAX - 3, u32::MAX - 3, u32::MAX, u32::MAX), 11),
            Some(RectU32::of(u32::MAX - 10, u32::MAX - 10, u32::MAX, u32::MAX))
        );
    }
    ...
    fn try_resize_odd_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize(&RectU32::of(0, 0, 2, 2), u32::MAX), Some(RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1)));
        assert_eq!(try_resize(&RectU32::of(u32::MAX - 2, u32::MAX - 2, u32::MAX, u32::MAX), u32::MAX), Some(RectU32::of(1, 1, u32::MAX, u32::MAX)));
    }

    #[test]
    fn try_resize_even_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize(&RectU32::of(0, 0, 3, 3), u32::MAX - 1), Some(RectU32::of(0, 0, u32::MAX - 2, u32::MAX - 2)));
        assert_eq!(
            try_resize(&RectU32::of(u32::MAX - 3, u32::MAX - 3, u32::MAX, u32::MAX), u32::MAX - 1),
    ...
    fn try_resize_big_rect_limits_out_of_bounds() {
        ...
        assert_eq!(try_resize(&RectU32::of(0, 0, u32::MAX, u32::MAX), u32::MAX), Some(RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1)));
    }
