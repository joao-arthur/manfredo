...
fn same_size() {
    ...
    assert_eq!(try_checked_resize(&RectU32::of(MAX - 2, MAX - 2, MAX, MAX), 3), Some(RectU32::of(MAX - 2, MAX - 2, MAX, MAX)));
    assert_eq!(try_checked_resize(&RectU32::of(MAX - 3, MAX - 3, MAX, MAX), 4), Some(RectU32::of(MAX - 3, MAX - 3, MAX, MAX)));
}
...
fn out_of_bounds() {
    ...
    assert_eq!(try_checked_resize(&RectU32::of(MAX - 2, MAX - 4, MAX, MAX - 2), 5), None);
    assert_eq!(try_checked_resize(&RectU32::of(MAX - 4, MAX - 2, MAX - 2, MAX), 5), None);
}

#[test]
fn small_rect_limits_out_of_bounds() {
    assert_eq!(try_checked_resize(&RectU32::of(0, 2, 2, 4), MAX), None);
    assert_eq!(try_checked_resize(&RectU32::of(2, 0, 4, 2), MAX), None);
    assert_eq!(try_checked_resize(&RectU32::of(MAX - 2, MAX - 4, MAX, MAX - 2), MAX), None);
    assert_eq!(try_checked_resize(&RectU32::of(MAX - 4, MAX - 2, MAX - 2, MAX), MAX), None);
}

#[test]
fn big_rect_limits_out_of_bounds() {
    assert_eq!(try_checked_resize(&RectU32::of(0, 0, MAX - 1, MAX - 1), MAX), Some(RectU32::of(0, 0, MAX - 1, MAX - 1)));
    assert_eq!(try_checked_resize(&RectU32::of(1, 1, MAX, MAX), MAX), Some(RectU32::of(1, 1, MAX, MAX)));
    assert_eq!(try_checked_resize(&RectU32::largest(), MAX), Some(RectU32::of(0, 0, MAX - 1, MAX - 1)));
}
