...
mod tests {
    ...
    fn assign_add_big_rect_limits_out_of_bounds() {
        ...
        assign_add(&mut r, &PointI32::min());
        assert_eq!(r, RectU32::largest());
        assign_add(&mut r, &PointI32::max());
        assert_eq!(r, RectU32::largest());
    ...
    fn add_small_rect_out_of_bounds() {
        assert_eq!(add(&RectU32::of(10, 5, 20, 30), &PointI32::of(-20, -20)), RectU32::of(0, 0, 10, 25));
        assert_eq!(
    ...
    fn add_big_rect_out_of_bounds() {
        assert_eq!(add(&RectU32::of(10, 5, u32::MAX, u32::MAX), &PointI32::of(-20, -20)), RectU32::of(0, 0, u32::MAX - 10, u32::MAX - 5));
        assert_eq!(add(&RectU32::of(0, 0, u32::MAX - 5, u32::MAX - 10), &PointI32::of(20, 20)), RectU32::of(5, 10, u32::MAX, u32::MAX));
    }

    #[test]
    fn add_small_rect_limits_out_of_bounds() {
        assert_eq!(add(&RectU32::of(1, 1, 10, 10), &PointI32::min()), RectU32::of(0, 0, 9, 9));
        assert_eq!(
    ...
    fn add_big_rect_limits_out_of_bounds() {
        assert_eq!(add(&RectU32::of(1, 1, u32::MAX, u32::MAX), &PointI32::min()), RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1));
        assert_eq!(add(&RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1), &PointI32::max()), RectU32::of(1, 1, u32::MAX, u32::MAX));
    }
}
