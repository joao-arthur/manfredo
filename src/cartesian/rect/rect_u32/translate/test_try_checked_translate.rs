...
#[test]
fn test() {
    assert_eq!(try_checked_translate(&Rect::of(0, 0, 12, 15), &PointI32::of(5, 4)), Some(Rect::of(5, 4, 17, 19)));
    assert_eq!(try_checked_translate(&Rect::of(5, 4, 17, 19), &PointI32::of(-4, -2)), Some(Rect::of(1, 2, 13, 17)));
}

#[test]
fn to_bounds() {
    assert_eq!(try_checked_translate(&Rect::of(2, 5, MAX, MAX), &PointI32::of(-2, -5)), Some(Rect::of(0, 0, MAX - 2, MAX - 5)));
    assert_eq!(try_checked_translate(&Rect::of(0, 0, MAX - 2, MAX - 5), &PointI32::of(2, 5)), Some(Rect::of(2, 5, MAX, MAX)));
}
