...
mod tests {
    ...
    fn assign_add_big_rect_limits_out_of_bounds() {
        ...
        let mut r_min_x = RectU64::of(1, 1, u64::MAX - 1, u64::MAX - 1);
        assign_add(&mut r_min_x, &RectI64::of(i64::MIN, 0, 0, 0));
        assert_eq!(r_min_x, RectU64::of(0, 1, u64::MAX - 1, u64::MAX - 1));

        let mut r_min_y = RectU64::of(1, 1, u64::MAX - 1, u64::MAX - 1);
        assign_add(&mut r_min_y, &RectI64::of(0, i64::MIN, 0, 0));
        assert_eq!(r_min_y, RectU64::of(1, 0, u64::MAX - 1, u64::MAX - 1));

        let mut r_max_x = RectU64::of(1, 1, u64::MAX - 1, u64::MAX - 1);
        assign_add(&mut r_max_x, &RectI64::of(0, 0, i64::MAX, 0));
        assert_eq!(r_max_x, RectU64::of(1, 1, u64::MAX, u64::MAX - 1));

        let mut r_max_y = RectU64::of(1, 1, u64::MAX - 1, u64::MAX - 1);
        assign_add(&mut r_max_y, &RectI64::of(0, 0, 0, i64::MAX));
        assert_eq!(r_max_y, RectU64::of(1, 1, u64::MAX - 1, u64::MAX));
    }
}
