...
fn limits_out_of_bounds() {
    let mut r = RectU64::largest();
    saturating_add_assign(&mut r, &Rect::of(i64::MIN, 0, 0, 0));
    assert_eq!(r, RectU64::largest());
    saturating_add_assign(&mut r, &Rect::of(0, i64::MIN, 0, 0));
    assert_eq!(r, RectU64::largest());
    saturating_add_assign(&mut r, &Rect::of(0, 0, i64::MAX, 0));
    assert_eq!(r, RectU64::largest());
    saturating_add_assign(&mut r, &Rect::of(0, 0, 0, i64::MAX));
    assert_eq!(r, RectU64::largest());
}
