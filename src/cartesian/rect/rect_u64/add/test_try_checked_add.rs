...
#[test]
fn test() {
    assert_eq!(try_checked_add(&RectU64::of(0, 0, 12, 10), &Rect::of(5, 4, 3, 2)), Some(RectU64::of(5, 4, 15, 12)));
    assert_eq!(try_checked_add(&RectU64::of(5, 4, 15, 12), &Rect::of(-4, -3, -2, -1)), Some(RectU64::of(1, 1, 13, 11)));
}
