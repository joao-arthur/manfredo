...
mod tests {
    ...
    fn try_checked_inflate_width_to_bounds() {
        assert_eq!(try_checked_inflate(&RectU64::of(1, 10, 20, 20)), Some(RectU64::of(0, 9, 21, 21)));
        assert_eq!(try_checked_inflate(&RectU64::of(10, 10, u64::MAX - 1, 20)), Some(RectU64::of(9, 9, u64::MAX, 21)));
    }

    #[test]
    fn try_checked_inflate_height_to_bounds() {
        assert_eq!(try_checked_inflate(&RectU64::of(10, 1, 20, 20)), Some(RectU64::of(9, 0, 21, 21)));
        assert_eq!(try_checked_inflate(&RectU64::of(10, 10, 20, u64::MAX - 1)), Some(RectU64::of(9, 9, 21, u64::MAX)));
    }

    #[test]
    fn try_checked_inflate_out_of_bounds() {
        assert_eq!(try_checked_inflate(&RectU64::of(0, 10, u64::MAX, 20)), None);
        assert_eq!(try_checked_inflate(&RectU64::of(10, 10, u64::MAX, 20)), None);
        assert_eq!(try_checked_inflate(&RectU64::of(10, 0, 20, 20)), None);
        assert_eq!(try_checked_inflate(&RectU64::of(10, 10, 20, u64::MAX)), None);
        assert_eq!(try_checked_inflate(&RectU64::of(0, 0, 10, 10)), None);
        assert_eq!(try_checked_inflate(&RectU64::of(10, 10, u64::MAX, u64::MAX)), None);
    }
    ...
    fn checked_inflate_max_bounds() {
        assert_eq!(
            checked_inflate(&RectU64::of(u64::MAX - 33, u64::MAX - 17, u64::MAX - 5, u64::MAX - 3)),
            RectU64::of(u64::MAX - 34, u64::MAX - 18, u64::MAX - 4, u64::MAX - 2)
        );
        assert_eq!(
            checked_inflate(&RectU64::of(u64::MAX - 34, u64::MAX - 18, u64::MAX - 4, u64::MAX - 2)),
            RectU64::of(u64::MAX - 35, u64::MAX - 19, u64::MAX - 3, u64::MAX - 1)
        );
        assert_eq!(
            checked_inflate(&RectU64::of(u64::MAX - 35, u64::MAX - 19, u64::MAX - 3, u64::MAX - 1)),
