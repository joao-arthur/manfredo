...
pub fn try_assign_resize_in_bounds(r: &mut RectU64, size: u64) -> Option<()> {
    if size < 3 {
        return None;
    }
...
pub fn try_resize_in_bounds(r: &RectU64, size: u64) -> Option<RectU64> {
    if size < 3 {
        return None;
    }
    let diff_x = i128::from(delta_x(r)) + 1 - i128::from(size);
    ...
    Some(RectU64 { min: point_u64::PointU64 { x: min_x, y: min_y }, max: point_u64::PointU64 { x: max_x, y: max_y } })
}

pub fn assign_resize_in_bounds(r: &mut RectU64, size: u64) {
    try_assign_resize_in_bounds(r, size).unwrap()
}

pub fn resize_in_bounds(r: &RectU64, size: u64) -> RectU64 {
    try_resize_in_bounds(r, size).unwrap()
}

#[cfg(test)]
mod tests {
    use super::{RectU64, assign_resize_in_bounds, resize_in_bounds, try_assign_resize_in_bounds, try_resize_in_bounds};
    ...
    fn try_assign_resize_in_bounds_odd_small_rect_limits_out_of_bounds() {
        let mut r_min = RectU64::of(0, 0, 2, 2);
        assert_eq!(try_assign_resize_in_bounds(&mut r_min, u64::MAX), Some(()));
        assert_eq!(r_min, RectU64::of(0, 0, u64::MAX - 1, u64::MAX - 1));

        let mut r_max = RectU64::of(u64::MAX - 2, u64::MAX - 2, u64::MAX, u64::MAX);
        assert_eq!(try_assign_resize_in_bounds(&mut r_max, u64::MAX), Some(()));
    ...
    fn try_assign_resize_in_bounds_even_small_rect_limits_out_of_bounds() {
        let mut r = RectU64::of(0, 0, 3, 3);
        assert_eq!(try_assign_resize_in_bounds(&mut r, u64::MAX - 1), Some(()));
    ...
    fn try_assign_resize_in_bounds_big_rect_limits_out_of_bounds() {
        ...
        assert_eq!(try_assign_resize_in_bounds(&mut r_odd_1, u64::MAX), Some(()));
        ...
        let mut r_even = RectU64::of(0, 0, u64::MAX, u64::MAX);
        assert_eq!(try_assign_resize_in_bounds(&mut r_even, u64::MAX), Some(()));
        assert_eq!(r_even, RectU64::of(0, 0, u64::MAX - 1, u64::MAX - 1));
    }

    #[test]
    fn try_resize_in_bounds_odd() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(5, 5, 15, 15), 11), Some(RectU64::of(5, 5, 15, 15)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(5, 5, 15, 15), 9), Some(RectU64::of(6, 6, 14, 14)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(6, 6, 14, 14), 7), Some(RectU64::of(7, 7, 13, 13)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(7, 7, 13, 13), 5), Some(RectU64::of(8, 8, 12, 12)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(8, 8, 12, 12), 3), Some(RectU64::of(9, 9, 11, 11)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(9, 9, 11, 11), 9), Some(RectU64::of(6, 6, 14, 14)));
    }

    #[test]
    fn try_resize_in_bounds_even() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(5, 5, 14, 14), 10), Some(RectU64::of(5, 5, 14, 14)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(5, 5, 14, 14), 8), Some(RectU64::of(6, 6, 13, 13)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(6, 6, 13, 13), 6), Some(RectU64::of(7, 7, 12, 12)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(7, 7, 12, 12), 4), Some(RectU64::of(8, 8, 11, 11)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(8, 8, 11, 11), 8), Some(RectU64::of(6, 6, 13, 13)));
    }

    #[test]
    fn try_resize_in_bounds_small_size() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(10, 10, 100, 100), 0), None);
        assert_eq!(try_resize_in_bounds(&RectU64::of(10, 10, 100, 100), 1), None);
        assert_eq!(try_resize_in_bounds(&RectU64::of(10, 10, 100, 100), 2), None);
    }

    #[test]
    fn try_resize_in_bounds_same_size() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(10, 10, 20, 20), 11), Some(RectU64::of(10, 10, 20, 20)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(10, 10, 21, 21), 12), Some(RectU64::of(10, 10, 21, 21)));
        assert_eq!(try_resize_in_bounds(&RectU64::of(9, 9, 21, 21), 13), Some(RectU64::of(9, 9, 21, 21)));
    }

    #[test]
    fn try_resize_in_bounds_odd_small_rect_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(0, 0, 2, 2), 11), Some(RectU64::of(0, 0, 10, 10)));
        assert_eq!(
            try_resize_in_bounds(&RectU64::of(u64::MAX - 2, u64::MAX - 2, u64::MAX, u64::MAX), 11),
    ...
    fn try_resize_in_bounds_even_small_rect_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(0, 0, 3, 3), 11), Some(RectU64::of(0, 0, 10, 10)));
        assert_eq!(
            try_resize_in_bounds(&RectU64::of(u64::MAX - 3, u64::MAX - 3, u64::MAX, u64::MAX), 11),
            Some(RectU64::of(u64::MAX - 10, u64::MAX - 10, u64::MAX, u64::MAX))
        );
    }
    ...
    fn try_resize_in_bounds_even_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize_in_bounds(&RectU64::of(0, 0, 3, 3), u64::MAX - 1), Some(RectU64::of(0, 0, u64::MAX - 2, u64::MAX - 2)));
        assert_eq!(
            try_resize_in_bounds(&RectU64::of(u64::MAX - 3, u64::MAX - 3, u64::MAX, u64::MAX), u64::MAX - 1),
    ...
    fn resize_in_bounds_odd() {
        assert_eq!(resize_in_bounds(&RectU64::of(5, 5, 15, 15), 11), RectU64::of(5, 5, 15, 15));
        assert_eq!(resize_in_bounds(&RectU64::of(5, 5, 15, 15), 9), RectU64::of(6, 6, 14, 14));
        assert_eq!(resize_in_bounds(&RectU64::of(6, 6, 14, 14), 7), RectU64::of(7, 7, 13, 13));
        assert_eq!(resize_in_bounds(&RectU64::of(7, 7, 13, 13), 5), RectU64::of(8, 8, 12, 12));
        assert_eq!(resize_in_bounds(&RectU64::of(8, 8, 12, 12), 3), RectU64::of(9, 9, 11, 11));
        assert_eq!(resize_in_bounds(&RectU64::of(9, 9, 11, 11), 9), RectU64::of(6, 6, 14, 14));
    }

    #[test]
    fn resize_in_bounds_even() {
        assert_eq!(resize_in_bounds(&RectU64::of(5, 5, 14, 14), 10), RectU64::of(5, 5, 14, 14));
        assert_eq!(resize_in_bounds(&RectU64::of(5, 5, 14, 14), 8), RectU64::of(6, 6, 13, 13));
        assert_eq!(resize_in_bounds(&RectU64::of(6, 6, 13, 13), 6), RectU64::of(7, 7, 12, 12));
        assert_eq!(resize_in_bounds(&RectU64::of(7, 7, 12, 12), 4), RectU64::of(8, 8, 11, 11));
        assert_eq!(resize_in_bounds(&RectU64::of(8, 8, 11, 11), 8), RectU64::of(6, 6, 13, 13));
    }
}
