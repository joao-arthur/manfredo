...
mod tests {
    ...
    fn assign_add_big_rect_limits_out_of_bounds() {
        ...
        assign_add(&mut r, &PointI64::min());
        assert_eq!(r, RectU64::largest());
        assign_add(&mut r, &PointI64::max());
        assert_eq!(r, RectU64::largest());
    ...
    fn add_small_rect_out_of_bounds() {
        assert_eq!(add(&RectU64::of(10, 5, 20, 30), &PointI64::of(-20, -20)), RectU64::of(0, 0, 10, 25));
        assert_eq!(
    ...
    fn add_big_rect_out_of_bounds() {
        assert_eq!(add(&RectU64::of(10, 5, u64::MAX, u64::MAX), &PointI64::of(-20, -20)), RectU64::of(0, 0, u64::MAX - 10, u64::MAX - 5));
        assert_eq!(add(&RectU64::of(0, 0, u64::MAX - 5, u64::MAX - 10), &PointI64::of(20, 20)), RectU64::of(5, 10, u64::MAX, u64::MAX));
    }

    #[test]
    fn add_small_rect_limits_out_of_bounds() {
        assert_eq!(add(&RectU64::of(1, 1, 10, 10), &PointI64::min()), RectU64::of(0, 0, 9, 9));
        assert_eq!(
    ...
    fn add_big_rect_limits_out_of_bounds() {
        assert_eq!(add(&RectU64::of(1, 1, u64::MAX, u64::MAX), &PointI64::min()), RectU64::of(0, 0, u64::MAX - 1, u64::MAX - 1));
        assert_eq!(add(&RectU64::of(0, 0, u64::MAX - 1, u64::MAX - 1), &PointI64::max()), RectU64::of(1, 1, u64::MAX, u64::MAX));
    }
}
