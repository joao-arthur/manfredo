...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(saturating_add(&r, &RectI::of(i8::MIN, 0, 0, 0)), Rect::largest());
    assert_eq!(saturating_add(&r, &RectI::of(0, i8::MIN, 0, 0)), Rect::largest());
    assert_eq!(saturating_add(&r, &RectI::of(0, 0, i8::MAX, 0)), Rect::largest());
    assert_eq!(saturating_add(&r, &RectI::of(0, 0, 0, i8::MAX)), Rect::largest());
}
