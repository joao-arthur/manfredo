...
use crate::cartesian::rect::{rect_i8::Rect as RectI, rect_u8::Rect};
...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(wrapping_add(&r, &RectI::of(i8::MIN, 0, 0, 0)), Rect::of(MAX / 2 + 1, 0, MAX, MAX));
    assert_eq!(wrapping_add(&r, &RectI::of(0, i8::MIN, 0, 0)), Rect::of(0, MAX / 2 + 1, MAX, MAX));
    assert_eq!(wrapping_add(&r, &RectI::of(0, 0, i8::MAX, 0)), Rect::of(0, 0, MAX / 2 - 1, MAX));
    assert_eq!(wrapping_add(&r, &RectI::of(0, 0, 0, i8::MAX)), Rect::of(0, 0, MAX, MAX / 2 - 1));
}
