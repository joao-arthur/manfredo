...
mod tests {
    ...
    fn try_assign_inflate_min_bounds() {
        let mut r = RectU8::of(7, 3, 4, 13);
        assert_eq!(try_assign_inflate(&mut r), Some(()));
        assert_eq!(r, RectU8::of(6, 2, 5, 14));
        assert_eq!(try_assign_inflate(&mut r), Some(()));
        assert_eq!(r, RectU8::of(5, 1, 6, 15));
        assert_eq!(try_assign_inflate(&mut r), Some(()));
        assert_eq!(r, RectU8::of(4, 0, 7, 16));
    }
    ...
    fn try_inflate_min_bounds() {
        assert_eq!(try_inflate(&RectU8::of(7, 3, 4, 13)), Some(RectU8::of(6, 2, 5, 14)));
        assert_eq!(try_inflate(&RectU8::of(6, 2, 5, 14)), Some(RectU8::of(5, 1, 6, 15)));
        assert_eq!(try_inflate(&RectU8::of(5, 1, 6, 15)), Some(RectU8::of(4, 0, 7, 16)));
    }
    ...
    fn try_inflate_out_of_bounds() {
        ...
        assert_eq!(try_inflate(&RectU8::of(10, 10, u8::MAX, 100)), None);
        assert_eq!(try_inflate(&RectU8::of(10, 0, 100, 100)), None);
        assert_eq!(try_inflate(&RectU8::of(10, 10, 100, u8::MAX)), None);
    ...
    fn inflate_min_bounds() {
        assert_eq!(inflate(&RectU8::of(7, 3, 4, 13)), RectU8::of(6, 2, 5, 14));
        assert_eq!(inflate(&RectU8::of(6, 2, 5, 14)), RectU8::of(5, 1, 6, 15));
        assert_eq!(inflate(&RectU8::of(5, 1, 6, 15)), RectU8::of(4, 0, 7, 16));
    }
