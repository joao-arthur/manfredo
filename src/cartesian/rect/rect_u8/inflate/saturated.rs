...
mod tests {
    ...
    fn try_inflate_to_bounds() {
        ...
        assert_eq!(try_inflate(&RectU8::of(0, 0, u8::MAX - 1, u8::MAX - 1)), Some(RectU8::of(0, 0, u8::MAX, u8::MAX)));
        assert_eq!(try_inflate(&RectU8::of(1, 1, u8::MAX, u8::MAX)), Some(RectU8::of(0, 0, u8::MAX, u8::MAX)));
    }
