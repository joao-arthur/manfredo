...
mod tests {
    ...
    fn try_resize_small_size() {
        assert_eq!(try_resize(&RectU8::of(10, 10, 100, 100), 0), None);
        assert_eq!(try_resize(&RectU8::of(10, 10, 100, 100), 1), None);
        assert_eq!(try_resize(&RectU8::of(10, 10, 100, 100), 2), None);
    }
    ...
    fn try_resize_big_rect_limits_out_of_bounds() {
        ...
        assert_eq!(try_resize(&RectU8::of(0, 0, u8::MAX, u8::MAX), u8::MAX), Some(RectU8::of(0, 0, u8::MAX - 1, u8::MAX - 1)));
    }
