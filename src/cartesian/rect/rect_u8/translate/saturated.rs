...
mod tests {
    ...
    fn saturating_translate_assign_big_rect_limits_out_of_bounds() {
        ...
        saturating_translate_assign(&mut r, &PointI8::min());
        assert_eq!(r, RectU8::largest());
        saturating_translate_assign(&mut r, &PointI8::max());
        assert_eq!(r, RectU8::largest());
    ...
    fn saturating_translate_small_rect_to_bounds() {
        assert_eq!(saturating_translate(&RectU8::of(2, 5, 12, 15), &PointI8::of(-2, -5)), RectU8::of(0, 0, 10, 10));
        assert_eq!(
            saturating_translate(&RectU8::of(u8::MAX - 12, u8::MAX - 15, u8::MAX - 2, u8::MAX - 5), &PointI8::of(2, 5)),
    ...
    fn saturating_translate_small_rect_out_of_bounds() {
        assert_eq!(saturating_translate(&RectU8::of(10, 5, 20, 30), &PointI8::of(-20, -20)), RectU8::of(0, 0, 10, 25));
        assert_eq!(
            saturating_translate(&RectU8::of(u8::MAX - 20, u8::MAX - 30, u8::MAX - 5, u8::MAX - 10), &PointI8::of(20, 20)),
    ...
    fn saturating_translate_big_rect_out_of_bounds() {
        assert_eq!(saturating_translate(&RectU8::of(10, 5, u8::MAX, u8::MAX), &PointI8::of(-20, -20)), RectU8::of(0, 0, u8::MAX - 10, u8::MAX - 5));
        assert_eq!(saturating_translate(&RectU8::of(0, 0, u8::MAX - 5, u8::MAX - 10), &PointI8::of(20, 20)), RectU8::of(5, 10, u8::MAX, u8::MAX));
    }

    #[test]
    fn saturating_translate_small_rect_limits_out_of_bounds() {
        assert_eq!(saturating_translate(&RectU8::of(1, 1, 10, 10), &PointI8::min()), RectU8::of(0, 0, 9, 9));
        assert_eq!(
            saturating_translate(&RectU8::of(u8::MAX - 10, u8::MAX - 10, u8::MAX - 1, u8::MAX - 1), &PointI8::max()),
    ...
    fn saturating_translate_big_rect_limits_out_of_bounds() {
        assert_eq!(saturating_translate(&RectU8::of(1, 1, u8::MAX, u8::MAX), &PointI8::min()), RectU8::of(0, 0, u8::MAX - 1, u8::MAX - 1));
        assert_eq!(saturating_translate(&RectU8::of(0, 0, u8::MAX - 1, u8::MAX - 1), &PointI8::max()), RectU8::of(1, 1, u8::MAX, u8::MAX));
    }
}
