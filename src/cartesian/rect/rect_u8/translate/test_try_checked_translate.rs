...
#[test]
fn to_bounds() {
    assert_eq!(try_checked_translate(&RectU8::of(2, 5, MAX, MAX), &PointI8::of(-2, -5)), Some(RectU8::of(0, 0, MAX - 2, MAX - 5)));
    assert_eq!(try_checked_translate(&RectU8::of(0, 0, MAX - 2, MAX - 5), &PointI8::of(2, 5)), Some(RectU8::of(2, 5, MAX, MAX)));
}
