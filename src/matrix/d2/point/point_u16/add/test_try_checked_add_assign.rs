...
use crate::matrix::{
    ...
    d2::point::{point_i16::Point as PointI, point_u16::Point},
};
...
fn limits_out_of_bounds() {
    ...
    assert_eq!(try_checked_add_assign(&mut p_min, &PointI::new(i16::MIN, 0)), None);
    assert_eq!(try_checked_add_assign(&mut p_min, &PointI::new(0, i16::MIN)), None);
    ...
    assert_eq!(try_checked_add_assign(&mut p_max, &PointI::new(i16::MAX, 0)), None);
    assert_eq!(try_checked_add_assign(&mut p_max, &PointI::new(0, i16::MAX)), None);
