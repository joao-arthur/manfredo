...
fn limits_out_of_bounds() {
    ...
    assert_eq!(try_checked_add_assign(&mut p_min, &PointI::new(i64::MIN, 0)), None);
    assert_eq!(try_checked_add_assign(&mut p_min, &PointI::new(0, i64::MIN)), None);
    ...
    assert_eq!(try_checked_add_assign(&mut p_max, &PointI::new(i64::MAX, 0)), None);
    assert_eq!(try_checked_add_assign(&mut p_max, &PointI::new(0, i64::MAX)), None);
