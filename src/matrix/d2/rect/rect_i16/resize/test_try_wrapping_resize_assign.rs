...
#[test]
fn same_size() {
    let mut r_min_2 = Rect::of(MIN, MIN, MIN + 2, MIN + 2);
    assert_eq!(try_wrapping_resize_assign(&mut r_min_2, 3), Some(()));
    assert_eq!(r_min_2, Rect::of(MIN, MIN, MIN + 2, MIN + 2));

    let mut r_min_3 = Rect::of(MIN, MIN, MIN + 3, MIN + 3);
    assert_eq!(try_wrapping_resize_assign(&mut r_min_3, 4), Some(()));
    assert_eq!(r_min_3, Rect::of(MIN, MIN, MIN + 3, MIN + 3));
