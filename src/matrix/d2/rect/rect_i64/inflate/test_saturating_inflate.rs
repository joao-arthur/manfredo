...
#[test]
fn min_bounds() {
    assert_eq!(saturating_inflate(&Rect::new((MIN + 7, MIN + 2), (MIN + 17, MIN + 13))), Rect::new((MIN + 6, MIN + 1), (MIN + 18, MIN + 14)));
    assert_eq!(saturating_inflate(&Rect::new((MIN + 6, MIN + 1), (MIN + 18, MIN + 14))), Rect::new((MIN + 5, MIN), (MIN + 19, MIN + 15)));
    assert_eq!(saturating_inflate(&Rect::new((MIN + 5, MIN), (MIN + 19, MIN + 15))), Rect::new((MIN + 4, MIN), (MIN + 20, MIN + 17)));
    assert_eq!(saturating_inflate(&Rect::new((MIN + 4, MIN), (MIN + 20, MIN + 17))), Rect::new((MIN + 3, MIN), (MIN + 21, MIN + 19)));
    assert_eq!(saturating_inflate(&Rect::new((MIN + 3, MIN), (MIN + 21, MIN + 19))), Rect::new((MIN + 2, MIN), (MIN + 22, MIN + 21)));
    assert_eq!(saturating_inflate(&Rect::new((MIN + 2, MIN), (MIN + 22, MIN + 21))), Rect::new((MIN + 1, MIN), (MIN + 23, MIN + 23)));
    assert_eq!(saturating_inflate(&Rect::new((MIN + 1, MIN), (MIN + 23, MIN + 23))), Rect::new((MIN, MIN), (MIN + 24, MIN + 25)));
    assert_eq!(saturating_inflate(&Rect::new((MIN, MIN), (MIN + 24, MIN + 25))), Rect::new((MIN, MIN), (MIN + 26, MIN + 27)));
}
