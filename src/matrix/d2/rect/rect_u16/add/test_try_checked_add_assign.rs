...
fn limits_out_of_bounds() {
    let mut r = Rect::largest();
    assert_eq!(try_checked_add_assign(&mut r, &RectI::new((i16::MIN, 0), (0, 0))), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI::new((0, i16::MIN), (0, 0))), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI::new((0, 0), (i16::MAX, 0))), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI::new((0, 0), (0, i16::MAX))), None);
    assert_eq!(r, Rect::largest());
}
