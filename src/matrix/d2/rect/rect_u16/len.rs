use crate::matrix::d2::rect::rect_u16::{Rect, delta_col, delta_row};
...
mod tests {
    ...
    #[test]
    fn len_max_bounds() {
        assert_eq!(len_max(&Rect::of(1, 0, u16::MAX - 1, u16::MAX - 1)), u16::MAX);
        assert_eq!(len_max(&Rect::of(0, 1, u16::MAX - 1, u16::MAX - 1)), u16::MAX);
        assert_eq!(len_max(&Rect::of(0, 0, u16::MAX - 2, u16::MAX - 1)), u16::MAX);
        assert_eq!(len_max(&Rect::of(0, 0, u16::MAX - 1, u16::MAX - 2)), u16::MAX);
    }
}
