...
fn limits_out_of_bounds() {
    ...
    saturating_translate_assign(&mut r, &Point::of(i16::MIN, 0));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::of(0, i16::MIN));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::of(i16::MAX, 0));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::of(0, i16::MAX));
    assert_eq!(r, Rect::largest());
}
