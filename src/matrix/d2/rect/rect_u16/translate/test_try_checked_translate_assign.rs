...
fn limits_out_of_bounds() {
    ...
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(i16::MIN, 0)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(0, i16::MIN)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(i16::MAX, 0)), None);
    assert_eq!(try_checked_translate_assign(&mut r, &Point::new(0, i16::MAX)), None);
