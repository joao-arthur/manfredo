...
use crate::matrix::d2::rect::{rect_i32::Rect as RectI, rect_u32::Rect};
...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(saturating_add(&r, &RectI::of(i32::MIN, 0, 0, 0)), Rect::largest());
    assert_eq!(saturating_add(&r, &RectI::of(0, i32::MIN, 0, 0)), Rect::largest());
    assert_eq!(saturating_add(&r, &RectI::of(0, 0, i32::MAX, 0)), Rect::largest());
    assert_eq!(saturating_add(&r, &RectI::of(0, 0, 0, i32::MAX)), Rect::largest());
}
