...
#[test]
fn test() {
    assert_eq!(try_checked_add(&Rect::new((0, 0), (12, 15)), &RectI::new((5, 4), (3, 2))), Some(Rect::new((5, 4), (15, 17))));
    assert_eq!(try_checked_add(&Rect::new((5, 4), (15, 20)), &RectI::new((-4, -3), (-2, -1))), Some(Rect::new((1, 1), (13, 19))));
}
...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(try_checked_add(&r, &RectI::new((i32::MIN, 0), (0, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::new((0, i32::MIN), (0, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::new((0, 0), (i32::MAX, 0))), None);
    assert_eq!(try_checked_add(&r, &RectI::new((0, 0), (0, i32::MAX))), None);
}
