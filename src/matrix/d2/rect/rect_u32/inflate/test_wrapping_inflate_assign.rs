...
fn to_bounds() {
    ...
    let mut r_min_row = Rect::of(1, 10, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_row);
    assert_eq!(r_min_row, Rect::of(0, 9, MAX - 9, MAX - 9));
...
fn out_of_bounds() {
    ...
    let mut r_min_row = Rect::of(0, 10, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_row);
    assert_eq!(r_min_row, Rect::of(MAX, 9, MAX - 9, MAX - 9));
