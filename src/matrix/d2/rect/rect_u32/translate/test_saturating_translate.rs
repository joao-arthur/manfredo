...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(saturating_translate(&r, &Point::of(i32::MIN, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::of(0, i32::MIN)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::of(i32::MAX, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::of(0, i32::MAX)), Rect::largest());
}
