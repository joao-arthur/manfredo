...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(try_checked_translate(&r, &Point::of(i32::MIN, 0)), None);
    assert_eq!(try_checked_translate(&r, &Point::of(0, i32::MIN)), None);
    assert_eq!(try_checked_translate(&r, &Point::of(i32::MAX, 0)), None);
    assert_eq!(try_checked_translate(&r, &Point::of(0, i32::MAX)), None);
}
