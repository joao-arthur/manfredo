...
fn limits_out_of_bounds() {
    let mut r = Rect::largest();
    saturating_add_assign(&mut r, &RectI::new((i64::MIN, 0), (0, 0)));
    assert_eq!(r, Rect::largest());
    saturating_add_assign(&mut r, &RectI::new((0, i64::MIN), (0, 0)));
    assert_eq!(r, Rect::largest());
    saturating_add_assign(&mut r, &RectI::new((0, 0), (i64::MAX, 0)));
    assert_eq!(r, Rect::largest());
    saturating_add_assign(&mut r, &RectI::new((0, 0), (0, i64::MAX)));
    assert_eq!(r, Rect::largest());
}
