use crate::matrix::d2::{point::point_u64, rect::rect_u64::Rect};
...
mod tests {
    ...
    #[test]
    fn delta_max_bounds() {
        assert_eq!(delta_max(&Rect::of(0, 0, u64::MAX, u64::MAX - 1)), u64::MAX);
        assert_eq!(delta_max(&Rect::of(0, 0, u64::MAX - 1, u64::MAX)), u64::MAX);
    }
}
