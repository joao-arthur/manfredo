...
mod tests {
    ...
    #[test]
    fn len_max_bounds() {
        assert_eq!(len_max(&Rect::of(1, 0, u64::MAX - 1, u64::MAX - 1)), u64::MAX);
        assert_eq!(len_max(&Rect::of(0, 1, u64::MAX - 1, u64::MAX - 1)), u64::MAX);
        assert_eq!(len_max(&Rect::of(0, 0, u64::MAX - 2, u64::MAX - 1)), u64::MAX);
        assert_eq!(len_max(&Rect::of(0, 0, u64::MAX - 1, u64::MAX - 2)), u64::MAX);
    }
}
