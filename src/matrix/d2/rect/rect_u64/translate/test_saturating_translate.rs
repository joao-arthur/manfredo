...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(saturating_translate(&r, &Point::new(i64::MIN, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::new(0, i64::MIN)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::new(i64::MAX, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::new(0, i64::MAX)), Rect::largest());
}
