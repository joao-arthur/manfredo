...
fn limits_out_of_bounds() {
    ...
    saturating_translate_assign(&mut r, &Point::of(i64::MIN, 0));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::of(0, i64::MIN));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::of(i64::MAX, 0));
    assert_eq!(r, Rect::largest());
    saturating_translate_assign(&mut r, &Point::of(0, i64::MAX));
    assert_eq!(r, Rect::largest());
}
