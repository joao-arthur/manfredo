...
fn limits_out_of_bounds() {
    let r = Rect::largest();
    assert_eq!(saturating_translate(&r, &Point::new(i8::MIN, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::new(0, i8::MIN)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::new(i8::MAX, 0)), Rect::largest());
    assert_eq!(saturating_translate(&r, &Point::new(0, i8::MAX)), Rect::largest());
}
