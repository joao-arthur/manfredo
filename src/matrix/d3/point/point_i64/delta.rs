...
mod tests {
    ...
    #[test]
    fn test_delta_row() {
        assert_eq!(delta_row(&Point::new(MIN, 0, 0), &Point::new(MAX, 0, 0)), u64::MAX);
    ...
    fn test_delta_col() {
        ...
        assert_eq!(delta_col(&Point::new(0, MIN, 0), &Point::new(0, MAX, 0)), u64::MAX);
    ...
    fn test_delta_depth() {
        ...
        assert_eq!(delta_depth(&Point::new(0, 0, MIN), &Point::new(0, 0, MAX)), u64::MAX);
    }
