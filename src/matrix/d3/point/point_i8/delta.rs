...
mod tests {
    ...
    #[test]
    fn test_delta_row() {
        assert_eq!(delta_row(&Point::of(MIN, 0, 0), &Point::of(MAX, 0, 0)), u8::MAX);
    ...
    fn test_delta_col() {
        ...
        assert_eq!(delta_col(&Point::of(0, MIN, 0), &Point::of(0, MAX, 0)), u8::MAX);
    ...
    fn test_delta_depth() {
        ...
        assert_eq!(delta_depth(&Point::of(0, 0, MIN), &Point::of(0, 0, MAX)), u8::MAX);
    }
