use super::Point;
use crate::matrix::d3::point::point_u8;
...
pub fn delta(p1: &Point, p2: &Point) -> point_u8::Point {
    point_u8::Point { row: delta_row(p1, p2), col: delta_col(p1, p2), depth: delta_depth(p1, p2) }
}
...
mod tests {
    ...
    #[test]
    fn test_delta_row() {
        assert_eq!(delta_row(&Point::new(MIN, 0, 0), &Point::new(MAX, 0, 0)), u8::MAX);
    ...
    fn test_delta_col() {
        ...
        assert_eq!(delta_col(&Point::new(0, MIN, 0), &Point::new(0, MAX, 0)), u8::MAX);
    ...
    fn test_delta_depth() {
        ...
        assert_eq!(delta_depth(&Point::new(0, 0, MIN), &Point::new(0, 0, MAX)), u8::MAX);
    }
