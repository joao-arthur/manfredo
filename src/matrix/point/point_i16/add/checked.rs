...
mod tests {
    ...
    fn try_checked_add_to_bounds() {
        assert_eq!(try_checked_add(&PointI16::of(i16::MIN + 2, i16::MIN + 5), &PointI16::of(-2, -5)), Some(PointI16::min()));
        assert_eq!(try_checked_add(&PointI16::of(i16::MAX - 2, i16::MAX - 5), &PointI16::of(2, 5)), Some(PointI16::max()));
    }
