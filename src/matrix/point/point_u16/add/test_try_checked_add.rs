...
#[test]
fn test() {
    assert_eq!(try_checked_add(&PointU16::min(), &PointI::of(10, 13)), Some(PointU16::of(10, 13)));
    assert_eq!(try_checked_add(&PointU16::of(10, 10), &PointI::of(-5, -3)), Some(PointU16::of(5, 7)));
}

#[test]
fn to_bounds() {
    assert_eq!(try_checked_add(&PointU16::of(2, 5), &PointI::of(-2, -5)), Some(PointU16::min()));
    assert_eq!(try_checked_add(&PointU16::of(MAX - 2, MAX - 5), &PointI::of(2, 5)), Some(PointU16::max()));
}
