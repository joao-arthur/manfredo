...
#[test]
fn test() {
    assert_eq!(try_checked_add(&PointU32::min(), &PointI::of(10, 13)), Some(PointU32::of(10, 13)));
    assert_eq!(try_checked_add(&PointU32::of(10, 10), &PointI::of(-5, -3)), Some(PointU32::of(5, 7)));
}

#[test]
fn to_bounds() {
    assert_eq!(try_checked_add(&PointU32::of(2, 5), &PointI::of(-2, -5)), Some(PointU32::min()));
    assert_eq!(try_checked_add(&PointU32::of(MAX - 2, MAX - 5), &PointI::of(2, 5)), Some(PointU32::max()));
}
...
fn out_of_bounds() {
    ...
    let m_max = PointU32::of(MAX - 2, MAX - 5);
...
fn limits_out_of_bounds() {
    ...
    let p_max = PointU32::of(MAX - 1, MAX - 1);
