...
mod tests {
    ...
    fn wrapping_add_to_bounds() {
        ...
        assert_eq!(wrapping_add(&PointU8::of(u8::MAX - 2, u8::MAX - 5), &PointI8::of(2, 5)), PointU8::max());
    }

    #[test]
    fn wrapping_add_out_of_bounds() {
        assert_eq!(wrapping_add(&PointU8::of(2, 5), &PointI8::of(-10, -10)), PointU8::of(u8::MAX - 7, u8::MAX - 4));
        assert_eq!(wrapping_add(&PointU8::of(u8::MAX - 2, u8::MAX - 5), &PointI8::of(10, 10)), PointU8::of(7, 4));
    }

    #[test]
    fn wrapping_add_limits_out_of_bounds() {
        assert_eq!(wrapping_add(&PointU8::of(1, 1), &PointI8::min()), PointU8::of(129, 129));
        assert_eq!(wrapping_add(&PointU8::of(u8::MAX - 1, u8::MAX - 1), &PointI8::max()), PointU8::of(125, 125));
    }
}
