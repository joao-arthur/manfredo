...
#[test]
fn to_bounds() {
    assert_eq!(try_checked_add(&RectI16::of(MIN + 2, MIN + 5, MAX - 2, MAX - 5), &RectI16::of(-2, -5, 2, 5)), Some(RectI16::largest()));
    assert_eq!(try_checked_add(&RectI16::of(MIN + 2, MIN + 5, MAX, MAX), &RectI16::of(-2, -5, 0, 0)), Some(RectI16::largest()));
    assert_eq!(try_checked_add(&RectI16::of(MIN, MIN, MAX - 2, MAX - 5), &RectI16::of(0, 0, 2, 5)), Some(RectI16::largest()));
}
...
fn limits_out_of_bounds() {
    let r = RectI16::largest();
    assert_eq!(try_checked_add(&r, &RectI16::of(MIN, 0, 0, 0)), None);
    assert_eq!(try_checked_add(&r, &RectI16::of(0, MIN, 0, 0)), None);
    assert_eq!(try_checked_add(&r, &RectI16::of(0, 0, MAX, 0)), None);
    assert_eq!(try_checked_add(&r, &RectI16::of(0, 0, 0, MAX)), None);
}
