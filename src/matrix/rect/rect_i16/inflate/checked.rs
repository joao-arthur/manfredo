...
mod tests {
    ...
    fn try_checked_inflate_assign_out_of_bounds() {
        let mut r_min_row = RectI16::of(i16::MIN, i16::MIN + 10, i16::MAX, i16::MIN + 20);
        assert_eq!(try_checked_inflate_assign(&mut r_min_row), None);
        assert_eq!(r_min_row, RectI16::of(i16::MIN, i16::MIN + 10, i16::MAX, i16::MIN + 20));

        let mut r_max_row = RectI16::of(i16::MIN + 10, i16::MIN + 10, i16::MAX, i16::MIN + 20);
        assert_eq!(try_checked_inflate_assign(&mut r_max_row), None);
        assert_eq!(r_max_row, RectI16::of(i16::MIN + 10, i16::MIN + 10, i16::MAX, i16::MIN + 20));

        let mut r_min_col = RectI16::of(i16::MIN + 10, i16::MIN, i16::MIN + 20, i16::MIN + 20);
        assert_eq!(try_checked_inflate_assign(&mut r_min_col), None);
        assert_eq!(r_min_col, RectI16::of(i16::MIN + 10, i16::MIN, i16::MIN + 20, i16::MIN + 20));

        let mut r_max_col = RectI16::of(i16::MIN + 10, i16::MIN + 10, i16::MIN + 20, i16::MAX);
        assert_eq!(try_checked_inflate_assign(&mut r_max_col), None);
        assert_eq!(r_max_col, RectI16::of(i16::MIN + 10, i16::MIN + 10, i16::MIN + 20, i16::MAX));
    ...
    fn try_checked_inflate_width_to_bounds() {
        assert_eq!(try_checked_inflate(&RectI16::of(i16::MIN + 1, i16::MIN + 10, i16::MIN + 20, i16::MIN + 20)), Some(RectI16::of(i16::MIN, i16::MIN + 9, i16::MIN + 21, i16::MIN + 21)));
        assert_eq!(try_checked_inflate(&RectI16::of(i16::MIN + 10, i16::MIN + 10, i16::MAX - 1, i16::MIN + 20)), Some(RectI16::of(i16::MIN + 9, i16::MIN + 9, i16::MAX, i16::MIN + 21)));
    }

    #[test]
    fn try_checked_inflate_height_to_bounds() {
        assert_eq!(try_checked_inflate(&RectI16::of(i16::MIN + 10, i16::MIN + 1, i16::MIN + 20, i16::MIN + 20)), Some(RectI16::of(i16::MIN + 9, i16::MIN, i16::MIN + 21, i16::MIN + 21)));
        assert_eq!(try_checked_inflate(&RectI16::of(i16::MIN + 10, i16::MIN + 10, i16::MIN + 20, i16::MAX - 1)), Some(RectI16::of(i16::MIN + 9, i16::MIN + 9, i16::MIN + 21, i16::MAX)));
    }
    ...
    fn checked_inflate_min_bounds() {
        assert_eq!(checked_inflate(&RectI16::of(i16::MIN + 7, i16::MIN + 3, i16::MIN + 9, i16::MIN + 13)), RectI16::of(i16::MIN + 6, i16::MIN + 2, i16::MIN + 10, i16::MIN + 14));
        assert_eq!(checked_inflate(&RectI16::of(i16::MIN + 6, i16::MIN + 2, i16::MIN + 10, i16::MIN + 14)), RectI16::of(i16::MIN + 5, i16::MIN + 1, i16::MIN + 11, i16::MIN + 15));
        assert_eq!(checked_inflate(&RectI16::of(i16::MIN + 5, i16::MIN + 1, i16::MIN + 11, i16::MIN + 15)), RectI16::of(i16::MIN + 4, i16::MIN, i16::MIN + 12, i16::MIN + 16));
    }

    #[test]
    fn checked_inflate_max_bounds() {
        assert_eq!(checked_inflate(&RectI16::of(i16::MAX - 33, i16::MAX - 17, i16::MAX - 5, i16::MAX - 3)), RectI16::of(i16::MAX - 34, i16::MAX - 18, i16::MAX - 4, i16::MAX - 2));
        assert_eq!(checked_inflate(&RectI16::of(i16::MAX - 34, i16::MAX - 18, i16::MAX - 4, i16::MAX - 2)), RectI16::of(i16::MAX - 35, i16::MAX - 19, i16::MAX - 3, i16::MAX - 1));
        assert_eq!(checked_inflate(&RectI16::of(i16::MAX - 35, i16::MAX - 19, i16::MAX - 3, i16::MAX - 1)), RectI16::of(i16::MAX - 36, i16::MAX - 20, i16::MAX - 2, i16::MAX));
    }
}
