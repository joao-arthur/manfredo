...
fn to_bounds() {
    ...
    let mut r_min_row = RectI32::of(i32::MIN + 1, i32::MIN + 10, i32::MAX - 10, i32::MAX - 10);
    assert_eq!(try_saturating_inflate_assign(&mut r_min_row), Some(()));
    assert_eq!(r_min_row, RectI32::of(i32::MIN, i32::MIN + 9, i32::MAX - 9, i32::MAX - 9));
...
fn out_of_bounds() {
    ...
    let mut r_x = RectI32::of(i32::MIN, i32::MIN + 10, i32::MAX, i32::MAX - 10);
    assert_eq!(try_saturating_inflate_assign(&mut r_x), None);
    assert_eq!(r_x, RectI32::of(i32::MIN, i32::MIN + 10, i32::MAX, i32::MAX - 10));

    let mut r_y = RectI32::of(i32::MIN + 10, i32::MIN, i32::MAX - 10, i32::MAX);
    assert_eq!(try_saturating_inflate_assign(&mut r_y), None);
    assert_eq!(r_y, RectI32::of(i32::MIN + 10, i32::MIN, i32::MAX - 10, i32::MAX));
}
