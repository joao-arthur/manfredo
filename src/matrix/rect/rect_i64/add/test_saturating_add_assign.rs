...
fn test() {
    ...
    saturating_add_assign(&mut r, &RectI64::of(9, -10, 11, -12));
...
fn limits_out_of_bounds() {
    let mut r = RectI64::largest();
    saturating_add_assign(&mut r, &RectI64::of(MIN, 0, 0, 0));
    assert_eq!(r, RectI64::largest());
    saturating_add_assign(&mut r, &RectI64::of(0, MIN, 0, 0));
    assert_eq!(r, RectI64::largest());
    saturating_add_assign(&mut r, &RectI64::of(0, 0, MAX, 0));
    assert_eq!(r, RectI64::largest());
    saturating_add_assign(&mut r, &RectI64::of(0, 0, 0, MAX));
    assert_eq!(r, RectI64::largest());
}
