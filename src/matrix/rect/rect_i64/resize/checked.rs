use crate::matrix::{
    ...
    rect::rect_i64::{RectI64, delta_row, delta_col},
};
...
mod tests {
    ...
    fn try_assign_resize_odd_small_rect_limits_out_of_bounds() {
        ...
        let mut r_min_row = RectI64::of(i64::MIN, i64::MIN + 2, i64::MIN + 2, i64::MIN + 4);
        assert_eq!(try_assign_resize(&mut r_min_row, u64::MAX), None);
        assert_eq!(r_min_row, RectI64::of(i64::MIN, i64::MIN + 2, i64::MIN + 2, i64::MIN + 4));

        let mut r_min_col = RectI64::of(i64::MIN + 2, i64::MIN, i64::MIN + 4, i64::MIN + 2);
        assert_eq!(try_assign_resize(&mut r_min_col, u64::MAX), None);
        assert_eq!(r_min_col, RectI64::of(i64::MIN + 2, i64::MIN, i64::MIN + 4, i64::MIN + 2));
        ...
        let mut r_max_row = RectI64::of(i64::MAX - 2, i64::MAX - 4, i64::MAX, i64::MAX - 2);
        assert_eq!(try_assign_resize(&mut r_max_row, u64::MAX), None);
        assert_eq!(r_max_row, RectI64::of(i64::MAX - 2, i64::MAX - 4, i64::MAX, i64::MAX - 2));

        let mut r_max_col = RectI64::of(i64::MAX - 4, i64::MAX - 2, i64::MAX - 2, i64::MAX);
        assert_eq!(try_assign_resize(&mut r_max_col, u64::MAX), None);
        assert_eq!(r_max_col, RectI64::of(i64::MAX - 4, i64::MAX - 2, i64::MAX - 2, i64::MAX));
    }
    ...
    fn try_assign_resize_even_small_rect_limits_out_of_bounds() {
        ...
        let mut r_min_row = RectI64::of(i64::MIN, i64::MIN + 3, i64::MIN + 3, i64::MIN + 6);
        assert_eq!(try_assign_resize(&mut r_min_row, u64::MAX - 1), None);
        assert_eq!(r_min_row, RectI64::of(i64::MIN, i64::MIN + 3, i64::MIN + 3, i64::MIN + 6));

        let mut r_min_col = RectI64::of(i64::MIN + 3, i64::MIN, i64::MIN + 6, i64::MIN + 3);
        assert_eq!(try_assign_resize(&mut r_min_col, u64::MAX - 1), None);
        assert_eq!(r_min_col, RectI64::of(i64::MIN + 3, i64::MIN, i64::MIN + 6, i64::MIN + 3));
        ...
        let mut r_max_row = RectI64::of(i64::MAX - 3, i64::MAX - 6, i64::MAX, i64::MAX - 3);
        assert_eq!(try_assign_resize(&mut r_max_row, u64::MAX - 1), None);
        assert_eq!(r_max_row, RectI64::of(i64::MAX - 3, i64::MAX - 6, i64::MAX, i64::MAX - 3));

        let mut r_max_col = RectI64::of(i64::MAX - 6, i64::MAX - 3, i64::MAX - 3, i64::MAX);
        assert_eq!(try_assign_resize(&mut r_max_col, u64::MAX - 1), None);
        assert_eq!(r_max_col, RectI64::of(i64::MAX - 6, i64::MAX - 3, i64::MAX - 3, i64::MAX));
    }
    ...
    fn try_resize_odd_small_rect_same_size() {
        assert_eq!(
            try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 2, i64::MIN + 2), 3),
            Some(RectI64::of(i64::MIN, i64::MIN, i64::MIN + 2, i64::MIN + 2))
        );
        assert_eq!(
            try_resize(&RectI64::of(i64::MAX - 2, i64::MAX - 2, i64::MAX, i64::MAX), 3),
    ...
    fn try_resize_even_small_rect_same_size() {
        assert_eq!(
            try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 3, i64::MIN + 3), 4),
            Some(RectI64::of(i64::MIN, i64::MIN, i64::MIN + 3, i64::MIN + 3))
        );
        assert_eq!(
            try_resize(&RectI64::of(i64::MAX - 3, i64::MAX - 3, i64::MAX, i64::MAX), 4),
    ...
    fn try_resize_odd_small_rect_to_bounds() {
        assert_eq!(
            try_resize(&RectI64::of(i64::MIN + 2, i64::MIN + 2, i64::MIN + 4, i64::MIN + 4), 7),
            Some(RectI64::of(i64::MIN, i64::MIN, i64::MIN + 6, i64::MIN + 6))
        );
        assert_eq!(
            try_resize(&RectI64::of(i64::MAX - 4, i64::MAX - 4, i64::MAX - 2, i64::MAX - 2), 7),
    ...
    fn try_resize_even_small_rect_to_bounds() {
        assert_eq!(
            try_resize(&RectI64::of(i64::MIN + 2, i64::MIN + 2, i64::MIN + 5, i64::MIN + 5), 8),
            Some(RectI64::of(i64::MIN, i64::MIN, i64::MIN + 7, i64::MIN + 7))
        );
        assert_eq!(
            try_resize(&RectI64::of(i64::MAX - 5, i64::MAX - 5, i64::MAX - 2, i64::MAX - 2), 8),
    ...
    fn try_resize_odd_small_rect_out_of_bounds() {
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 2, i64::MIN + 2), 5), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN + 2, i64::MIN + 2, i64::MIN + 4), 5), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN + 2, i64::MIN, i64::MIN + 4, i64::MIN + 2), 5), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 2, i64::MAX - 2, i64::MAX, i64::MAX), 5), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 2, i64::MAX - 4, i64::MAX, i64::MAX - 2), 5), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 4, i64::MAX - 2, i64::MAX - 2, i64::MAX), 5), None);
    }

    #[test]
    fn try_resize_even_small_rect_out_of_bounds() {
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 3, i64::MIN + 3), 6), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN + 3, i64::MIN + 3, i64::MIN + 6), 6), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 3, i64::MIN + 3), 6), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 3, i64::MAX - 3, i64::MAX, i64::MAX), 6), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 3, i64::MAX - 6, i64::MAX, i64::MAX - 3), 6), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 6, i64::MAX - 3, i64::MAX - 3, i64::MAX), 6), None);
    }

    #[test]
    fn try_resize_odd_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 2, i64::MIN + 2), u64::MAX), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN + 2, i64::MIN + 2, i64::MIN + 4), u64::MAX), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN + 2, i64::MIN, i64::MIN + 4, i64::MIN + 2), u64::MAX), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 2, i64::MAX - 2, i64::MAX, i64::MAX), u64::MAX), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 2, i64::MAX - 4, i64::MAX, i64::MAX - 2), u64::MAX), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 4, i64::MAX - 2, i64::MAX - 2, i64::MAX), u64::MAX), None);
    }

    #[test]
    fn try_resize_even_small_rect_limits_out_of_bounds() {
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 3, i64::MIN + 3), u64::MAX - 1), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN + 3, i64::MIN + 3, i64::MIN + 6), u64::MAX - 1), None);
        assert_eq!(try_resize(&RectI64::of(i64::MIN, i64::MIN, i64::MIN + 3, i64::MIN + 3), u64::MAX - 1), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 3, i64::MAX - 3, i64::MAX, i64::MAX), u64::MAX - 1), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 3, i64::MAX - 6, i64::MAX, i64::MAX - 3), u64::MAX - 1), None);
        assert_eq!(try_resize(&RectI64::of(i64::MAX - 6, i64::MAX - 3, i64::MAX - 3, i64::MAX), u64::MAX - 1), None);
    }
