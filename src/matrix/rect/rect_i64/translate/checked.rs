...
mod tests {
    ...
    fn test_try_checked_translate() {
        assert_eq!(try_checked_translate(&RectI64::of(0, 0, 10, 10), &PointI64::of(10, 20)), Some(RectI64::of(10, 20, 20, 30)));
        assert_eq!(try_checked_translate(&RectI64::of(10, 20, 20, 30), &PointI64::of(-20, -15)), Some(RectI64::of(-10, 5, 0, 15)));
    }
    ...
    fn try_checked_translate_small_rect_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 10, i64::MIN + 5, i64::MIN + 20, i64::MIN + 30), &PointI64::of(-20, -20)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MAX - 20, i64::MAX - 30, i64::MAX - 5, i64::MAX - 10), &PointI64::of(20, 20)), None);
    }

    #[test]
    fn try_checked_translate_big_rect_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 10, i64::MIN + 5, i64::MAX, i64::MAX), &PointI64::of(-20, -20)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN, i64::MIN, i64::MAX - 5, i64::MAX - 10), &PointI64::of(20, 20)), None);
    }

    #[test]
    fn try_checked_translate_small_rect_limits_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MIN + 10, i64::MIN + 10), &PointI64::min()), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MIN + 10, i64::MIN + 10), &PointI64::of(i64::MIN, 0)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MIN + 10, i64::MIN + 10), &PointI64::of(0, i64::MIN)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MAX - 10, i64::MAX - 10, i64::MAX - 1, i64::MAX - 1), &PointI64::max()), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MAX - 10, i64::MAX - 10, i64::MAX - 1, i64::MAX - 1), &PointI64::of(i64::MAX, 0)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MAX - 10, i64::MAX - 10, i64::MAX - 1, i64::MAX - 1), &PointI64::of(0, i64::MAX)), None);
    }

    #[test]
    fn try_checked_translate_big_rect_limits_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectI64::largest(), &PointI64::min()), None);
        assert_eq!(try_checked_translate(&RectI64::largest(), &PointI64::max()), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN, i64::MIN, i64::MAX - 1, i64::MAX - 1), &PointI64::max()), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN, i64::MIN, i64::MAX - 1, i64::MAX - 1), &PointI64::of(i64::MAX, 0)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN, i64::MIN, i64::MAX - 1, i64::MAX - 1), &PointI64::of(0, i64::MAX)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX, i64::MAX), &PointI64::min()), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX, i64::MAX), &PointI64::of(i64::MIN, 0)), None);
        assert_eq!(try_checked_translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX, i64::MAX), &PointI64::of(0, i64::MIN)), None);
    }
