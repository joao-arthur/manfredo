...
mod tests {
    ...
    #[test]
    fn test_translate() {
        assert_eq!(translate(&RectI64::of(0, 0, 12, 15), &PointI64::of(5, 4)), RectI64::of(5, 4, 17, 19));
        assert_eq!(translate(&RectI64::of(5, 4, 17, 19), &PointI64::of(-4, -2)), RectI64::of(1, 2, 13, 17));
    }
    ...
    fn translate_small_rect_limits_out_of_bounds() {
        assert_eq!(translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MIN + 10, i64::MIN + 10), &PointI64::min()), RectI64::of(1, 1, 10, 10));
        assert_eq!(
    ...
    fn translate_big_rect_limits_out_of_bounds() {
        assert_eq!(translate(&RectI64::largest(), &PointI64::min()), RectI64::of(0, 0, -1, -1));
        assert_eq!(translate(&RectI64::largest(), &PointI64::max()), RectI64::of(-1, -1, -2, -2));
        assert_eq!(translate(&RectI64::of(i64::MIN + 1, i64::MIN + 1, i64::MAX, i64::MAX), &PointI64::min()), RectI64::of(1, 1, -1, -1));
        assert_eq!(translate(&RectI64::of(i64::MIN, i64::MIN, i64::MAX - 1, i64::MAX - 1), &PointI64::max()), RectI64::of(-1, -1, -3, -3));
    }
}
