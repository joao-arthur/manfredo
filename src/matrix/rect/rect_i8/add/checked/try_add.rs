...
mod tests {
    ...
    fn test_try_checked_add() {
        assert_eq!(try_checked_add(&RectI8::of(0, 0, 12, 15), &RectI8::of(5, 4, 3, 2)), Some(RectI8::of(5, 4, 15, 17)));
        assert_eq!(try_checked_add(&RectI8::of(5, 4, 15, 17), &RectI8::of(-14, -13, -12, -11)), Some(RectI8::of(-9, -9, 3, 6)));
    }

    #[test]
    fn try_checked_add_to_bounds() {
        assert_eq!(
            try_checked_add(&RectI8::of(i8::MIN + 2, i8::MIN + 5, i8::MAX - 2, i8::MAX - 5), &RectI8::of(-2, -5, 2, 5)),
            Some(RectI8::largest())
        );
