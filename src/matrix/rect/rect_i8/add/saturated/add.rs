...
mod tests {
    ...
    fn add_edge_out_of_bounds() {
        ...
        assert_eq!(add(&r, &RectI8::of(-1, 0, 0, 0)), RectI8::largest());
        assert_eq!(add(&r, &RectI8::of(0, -1, 0, 0)), RectI8::largest());
        assert_eq!(add(&r, &RectI8::of(0, 0, 1, 0)), RectI8::largest());
        assert_eq!(add(&r, &RectI8::of(0, 0, 0, 1)), RectI8::largest());
    }

    #[test]
    fn add_out_of_bounds() {
        let r = RectI8::of(i8::MIN + 10, i8::MIN + 10, i8::MAX - 10, i8::MAX - 10);
        assert_eq!(add(&r, &RectI8::of(-20, 0, 0, 0)), RectI8::of(i8::MIN, i8::MIN + 10, i8::MAX - 10, i8::MAX - 10));
        assert_eq!(add(&r, &RectI8::of(0, -20, 0, 0)), RectI8::of(i8::MIN + 10, i8::MIN, i8::MAX - 10, i8::MAX - 10));
        assert_eq!(add(&r, &RectI8::of(0, 0, 20, 0)), RectI8::of(i8::MIN + 10, i8::MIN + 10, i8::MAX, i8::MAX - 10));
        assert_eq!(add(&r, &RectI8::of(0, 0, 0, 20)), RectI8::of(i8::MIN + 10, i8::MIN + 10, i8::MAX - 10, i8::MAX));
    }

    #[test]
    fn add_limits_out_of_bounds() {
        let r = RectI8::largest();
        assert_eq!(add(&r, &RectI8::of(i8::MIN, 0, 0, 0)), RectI8::largest());
        assert_eq!(add(&r, &RectI8::of(0, i8::MIN, 0, 0)), RectI8::largest());
        assert_eq!(add(&r, &RectI8::of(0, 0, i8::MAX, 0)), RectI8::largest());
        assert_eq!(add(&r, &RectI8::of(0, 0, 0, i8::MAX)), RectI8::largest());
    }
}
