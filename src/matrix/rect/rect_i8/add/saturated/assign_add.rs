...
mod tests {
    ...
    fn assign_add_big_rect_limits_out_of_bounds() {
        ...
        let mut r_min_row = RectI8::of(i8::MIN + 1, i8::MIN + 1, i8::MAX - 1, i8::MAX - 1);
        assign_add(&mut r_min_row, &RectI8::of(i8::MIN, 0, 0, 0));
        assert_eq!(r_min_row, RectI8::of(i8::MIN, i8::MIN + 1, i8::MAX - 1, i8::MAX - 1));

        let mut r_min_col = RectI8::of(i8::MIN + 1, i8::MIN + 1, i8::MAX - 1, i8::MAX - 1);
        assign_add(&mut r_min_col, &RectI8::of(0, i8::MIN, 0, 0));
        assert_eq!(r_min_col, RectI8::of(i8::MIN + 1, i8::MIN, i8::MAX - 1, i8::MAX - 1));

        let mut r_max_row = RectI8::of(i8::MIN + 1, i8::MIN + 1, i8::MAX - 1, i8::MAX - 1);
        assign_add(&mut r_max_row, &RectI8::of(0, 0, i8::MAX, 0));
        assert_eq!(r_max_row, RectI8::of(i8::MIN + 1, i8::MIN + 1, i8::MAX, i8::MAX - 1));

        let mut r_max_col = RectI8::of(i8::MIN + 1, i8::MIN + 1, i8::MAX - 1, i8::MAX - 1);
        assign_add(&mut r_max_col, &RectI8::of(0, 0, 0, i8::MAX));
        assert_eq!(r_max_col, RectI8::of(i8::MIN + 1, i8::MIN + 1, i8::MAX - 1, i8::MAX));
    }
}
