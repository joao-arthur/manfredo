...
fn limits_out_of_bounds() {
    let mut r = RectI8::largest();
    saturating_add_assign(&mut r, &RectI8::of(MIN, 0, 0, 0));
    assert_eq!(r, RectI8::largest());
    saturating_add_assign(&mut r, &RectI8::of(0, MIN, 0, 0));
    assert_eq!(r, RectI8::largest());
    saturating_add_assign(&mut r, &RectI8::of(0, 0, MAX, 0));
    assert_eq!(r, RectI8::largest());
    saturating_add_assign(&mut r, &RectI8::of(0, 0, 0, MAX));
    assert_eq!(r, RectI8::largest());
}
