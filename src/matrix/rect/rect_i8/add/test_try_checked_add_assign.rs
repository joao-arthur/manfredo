...
fn test() {
    ...
    assert_eq!(try_checked_add_assign(&mut r, &RectI8::of(9, -10, 11, -12)), Some(()));
...
#[test]
fn out_of_bounds() {
    let mut r = RectI8::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    ...
    assert_eq!(r, RectI8::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10));
}
...
fn limits_out_of_bounds() {
    let mut r = RectI8::largest();
    assert_eq!(try_checked_add_assign(&mut r, &RectI8::of(MIN, 0, 0, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI8::of(0, MIN, 0, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI8::of(0, 0, MAX, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &RectI8::of(0, 0, 0, MAX)), None);
    assert_eq!(r, RectI8::largest());
}
