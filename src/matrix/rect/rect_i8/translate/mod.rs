...
pub fn saturating_translate(r: &Rect, delta: &PointI8) -> Rect {
    ...
    Rect { min: PointI8 { row: min_row as i8, col: min_col as i8 }, max: PointI8 { row: max_row as i8, col: max_col as i8 } }
}
...
pub fn wrapping_translate(r: &Rect, delta: &PointI8) -> Rect {
    ...
    let max_row = min_row.wrapping_add_unsigned(d_row);
    let max_col = min_col.wrapping_add_unsigned(d_col);
    Rect { min: PointI8 { row: min_row, col: min_col }, max: PointI8 { row: max_row, col: max_col } }
}
