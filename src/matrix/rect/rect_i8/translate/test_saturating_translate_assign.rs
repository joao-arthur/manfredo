...
fn out_of_bounds() {
    ...
    assert_eq!(r1, RectI8::of(MIN, MIN + 10, MAX - 20, MAX - 10));

    let mut r2 = RectI8::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    saturating_translate_assign(&mut r2, &PointI8::of(0, -20));
    assert_eq!(r2, RectI8::of(MIN + 10, MIN, MAX - 10, MAX - 20));

    let mut r3 = RectI8::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    saturating_translate_assign(&mut r3, &PointI8::of(20, 0));
    assert_eq!(r3, RectI8::of(MIN + 20, MIN + 10, MAX, MAX - 10));

    let mut r4 = RectI8::of(MIN + 10, MIN + 10, MAX - 10, MAX - 10);
    saturating_translate_assign(&mut r4, &PointI8::of(0, 20));
    assert_eq!(r4, RectI8::of(MIN + 10, MIN + 20, MAX - 10, MAX));
}

#[test]
fn limits_out_of_bounds() {
    let mut r = RectI8::largest();
    saturating_translate_assign(&mut r, &PointI8::of(MIN, 0));
    assert_eq!(r, RectI8::largest());
    saturating_translate_assign(&mut r, &PointI8::of(0, MIN));
    assert_eq!(r, RectI8::largest());
    saturating_translate_assign(&mut r, &PointI8::of(MAX, 0));
    assert_eq!(r, RectI8::largest());
    saturating_translate_assign(&mut r, &PointI8::of(0, MAX));
    assert_eq!(r, RectI8::largest());
}
