...
pub fn try_saturating_resize_assign(r: &mut RectU16, size: u16) -> Option<()> {
    if size < 3 {
        return None;
    }
...
pub fn try_saturating_resize(r: &RectU16, size: u16) -> Option<RectU16> {
    if size < 3 {
        return None;
    }
    let diff_row = i32::from(delta_row(r)) + 1 - i32::from(size);
...
pub fn saturating_resize_assign(r: &mut RectU16, size: u16) {
    try_saturating_resize_assign(r, size).unwrap()
}

pub fn saturating_resize(r: &RectU16, size: u16) -> RectU16 {
...
mod tests {
    ...
    fn try_saturating_resize_odd() {
        assert_eq!(try_saturating_resize(&RectU16::of(5, 5, 15, 15), 11), Some(RectU16::of(5, 5, 15, 15)));
    ...
    fn try_saturating_resize_same_size() {
        assert_eq!(try_saturating_resize(&RectU16::of(10, 10, 20, 20), 11), Some(RectU16::of(10, 10, 20, 20)));
        assert_eq!(try_saturating_resize(&RectU16::of(10, 10, 21, 21), 12), Some(RectU16::of(10, 10, 21, 21)));
        assert_eq!(try_saturating_resize(&RectU16::of(9, 9, 21, 21), 13), Some(RectU16::of(9, 9, 21, 21)));
    }
    ...
    fn try_saturating_resize_even_small_rect_out_of_bounds() {
        assert_eq!(try_saturating_resize(&RectU16::of(0, 0, 3, 3), 11), Some(RectU16::of(0, 0, 10, 10)));
        assert_eq!(
            try_saturating_resize(&RectU16::of(u16::MAX - 3, u16::MAX - 3, u16::MAX, u16::MAX), 11),
            Some(RectU16::of(u16::MAX - 10, u16::MAX - 10, u16::MAX, u16::MAX))
        );
    }
    ...
    fn try_saturating_resize_even_small_rect_limits_out_of_bounds() {
        assert_eq!(try_saturating_resize(&RectU16::of(0, 0, 3, 3), u16::MAX - 1), Some(RectU16::of(0, 0, u16::MAX - 2, u16::MAX - 2)));
        assert_eq!(
            try_saturating_resize(&RectU16::of(u16::MAX - 3, u16::MAX - 3, u16::MAX, u16::MAX), u16::MAX - 1),
    ...
    fn saturating_resize_odd() {
        assert_eq!(saturating_resize(&RectU16::of(5, 5, 15, 15), 11), RectU16::of(5, 5, 15, 15));
        assert_eq!(saturating_resize(&RectU16::of(5, 5, 15, 15), 9), RectU16::of(6, 6, 14, 14));
        assert_eq!(saturating_resize(&RectU16::of(6, 6, 14, 14), 7), RectU16::of(7, 7, 13, 13));
        assert_eq!(saturating_resize(&RectU16::of(7, 7, 13, 13), 5), RectU16::of(8, 8, 12, 12));
        assert_eq!(saturating_resize(&RectU16::of(8, 8, 12, 12), 3), RectU16::of(9, 9, 11, 11));
        assert_eq!(saturating_resize(&RectU16::of(9, 9, 11, 11), 9), RectU16::of(6, 6, 14, 14));
    }

    #[test]
    fn saturating_resize_even() {
        assert_eq!(saturating_resize(&RectU16::of(5, 5, 14, 14), 10), RectU16::of(5, 5, 14, 14));
        assert_eq!(saturating_resize(&RectU16::of(5, 5, 14, 14), 8), RectU16::of(6, 6, 13, 13));
        assert_eq!(saturating_resize(&RectU16::of(6, 6, 13, 13), 6), RectU16::of(7, 7, 12, 12));
        assert_eq!(saturating_resize(&RectU16::of(7, 7, 12, 12), 4), RectU16::of(8, 8, 11, 11));
        assert_eq!(saturating_resize(&RectU16::of(8, 8, 11, 11), 8), RectU16::of(6, 6, 13, 13));
    }
}
