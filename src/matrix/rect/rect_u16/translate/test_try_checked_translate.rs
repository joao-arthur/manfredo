...
#[test]
fn to_bounds() {
    assert_eq!(try_checked_translate(&RectU16::of(2, 5, MAX, MAX), &PointI16::of(-2, -5)), Some(RectU16::of(0, 0, MAX - 2, MAX - 5)));
    assert_eq!(try_checked_translate(&RectU16::of(0, 0, MAX - 2, MAX - 5), &PointI16::of(2, 5)), Some(RectU16::of(2, 5, MAX, MAX)));
}
