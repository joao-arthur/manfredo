...
fn to_bounds() {
    ...
    let mut r_min_row = RectU32::of(1, 10, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_row);
    assert_eq!(r_min_row, RectU32::of(0, 9, MAX - 9, MAX - 9));
...
fn out_of_bounds() {
    ...
    wrapping_inflate_assign(&mut r);
    assert_eq!(r, RectU32::of(MAX, MAX, 0, 0));

    let mut r_min_row = RectU32::of(0, 10, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_row);
    assert_eq!(r_min_row, RectU32::of(MAX, 9, MAX - 9, MAX - 9));

    let mut r_min_y = RectU32::of(10, 0, MAX - 10, MAX - 10);
    wrapping_inflate_assign(&mut r_min_y);
    assert_eq!(r_min_y, RectU32::of(9, MAX, MAX - 9, MAX - 9));

    let mut r_max_x = RectU32::of(10, 10, MAX, MAX - 10);
    wrapping_inflate_assign(&mut r_max_x);
    assert_eq!(r_max_x, RectU32::of(9, 9, 0, MAX - 9));

    let mut r_max_y = RectU32::of(10, 10, MAX - 10, MAX);
    wrapping_inflate_assign(&mut r_max_y);
    assert_eq!(r_max_y, RectU32::of(9, 9, MAX - 9, 0));
}
