...
mod tests {
    ...
    fn try_checked_translate_small_rect_to_bounds() {
        assert_eq!(try_checked_translate(&RectU32::of(2, 5, 12, 15), &PointI32::of(-2, -5)), Some(RectU32::of(0, 0, 10, 10)));
        assert_eq!(
            try_checked_translate(&RectU32::of(u32::MAX - 12, u32::MAX - 15, u32::MAX - 2, u32::MAX - 5), &PointI32::of(2, 5)),
    ...
    fn try_checked_translate_small_rect_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectU32::of(10, 5, 20, 30), &PointI32::of(-20, -20)), None);
        assert_eq!(try_checked_translate(&RectU32::of(u32::MAX - 20, u32::MAX - 30, u32::MAX - 5, u32::MAX - 10), &PointI32::of(20, 20)), None);
    }

    #[test]
    fn try_checked_translate_big_rect_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectU32::of(10, 5, u32::MAX, u32::MAX), &PointI32::of(-20, -20)), None);
        assert_eq!(try_checked_translate(&RectU32::of(0, 0, u32::MAX - 5, u32::MAX - 10), &PointI32::of(20, 20)), None);
    }

    #[test]
    fn try_checked_translate_small_rect_limits_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectU32::of(1, 1, 10, 10), &PointI32::min()), None);
        assert_eq!(try_checked_translate(&RectU32::of(1, 1, 10, 10), &PointI32::of(i32::MIN, 0)), None);
        assert_eq!(try_checked_translate(&RectU32::of(1, 1, 10, 10), &PointI32::of(0, i32::MIN)), None);
        assert_eq!(try_checked_translate(&RectU32::of(u32::MAX - 10, u32::MAX - 10, u32::MAX - 1, u32::MAX - 1), &PointI32::max()), None);
        assert_eq!(try_checked_translate(&RectU32::of(u32::MAX - 10, u32::MAX - 10, u32::MAX - 1, u32::MAX - 1), &PointI32::of(i32::MAX, 0)), None);
        assert_eq!(try_checked_translate(&RectU32::of(u32::MAX - 10, u32::MAX - 10, u32::MAX - 1, u32::MAX - 1), &PointI32::of(0, i32::MAX)), None);
    }

    #[test]
    fn try_checked_translate_big_rect_limits_out_of_bounds() {
        assert_eq!(try_checked_translate(&RectU32::largest(), &PointI32::min()), None);
        assert_eq!(try_checked_translate(&RectU32::largest(), &PointI32::min()), None);
        assert_eq!(try_checked_translate(&RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1), &PointI32::max()), None);
        assert_eq!(try_checked_translate(&RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1), &PointI32::of(i32::MAX, 0)), None);
        assert_eq!(try_checked_translate(&RectU32::of(0, 0, u32::MAX - 1, u32::MAX - 1), &PointI32::of(0, i32::MAX)), None);
        assert_eq!(try_checked_translate(&RectU32::of(1, 1, u32::MAX, u32::MAX), &PointI32::min()), None);
        assert_eq!(try_checked_translate(&RectU32::of(1, 1, u32::MAX, u32::MAX), &PointI32::of(i32::MIN, 0)), None);
        assert_eq!(try_checked_translate(&RectU32::of(1, 1, u32::MAX, u32::MAX), &PointI32::of(0, i32::MIN)), None);
    }
