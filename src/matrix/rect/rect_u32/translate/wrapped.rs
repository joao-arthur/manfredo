...
mod tests {
    ...
    fn translate_small_rect_out_of_bounds() {
        assert_eq!(translate(&RectU32::of(10, 5, 20, 30), &PointI32::of(-20, -20)), RectU32::of(u32::MAX - 9, u32::MAX - 14, 0, 10));
        assert_eq!(
    ...
    fn translate_big_rect_out_of_bounds() {
        assert_eq!(
            translate(&RectU32::of(10, 5, u32::MAX, u32::MAX), &PointI32::of(-20, -20)),
            RectU32::of(u32::MAX - 9, u32::MAX - 14, u32::MAX - 20, u32::MAX - 20)
        );
        assert_eq!(translate(&RectU32::of(0, 0, u32::MAX - 5, u32::MAX - 10), &PointI32::of(20, 20)), RectU32::of(20, 20, 14, 9));
    }

    #[test]
    fn translate_small_rect_limits_out_of_bounds() {
        assert_eq!(
            translate(&RectU32::of(1, 1, 10, 10), &PointI32::min()),
