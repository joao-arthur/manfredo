...
fn limits_out_of_bounds() {
    let mut r = RectU64::largest();
    assert_eq!(try_checked_add_assign(&mut r, &Rect::of(i64::MIN, 0, 0, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &Rect::of(0, i64::MIN, 0, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &Rect::of(0, 0, i64::MAX, 0)), None);
    assert_eq!(try_checked_add_assign(&mut r, &Rect::of(0, 0, 0, i64::MAX)), None);
    assert_eq!(r, RectU64::largest());
}
