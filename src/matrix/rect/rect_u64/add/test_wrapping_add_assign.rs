...
fn limits_out_of_bounds() {
    ...
    assert_eq!(r1, RectU64::of(u64::MAX / 2 + 1, 0, u64::MAX, u64::MAX));

    let mut r2 = RectU64::largest();
    wrapping_add_assign(&mut r2, &RectI64::of(0, i64::MIN, 0, 0));
    assert_eq!(r2, RectU64::of(0, u64::MAX / 2 + 1, u64::MAX, u64::MAX));

    let mut r3 = RectU64::largest();
    wrapping_add_assign(&mut r3, &RectI64::of(0, 0, i64::MAX, 0));
    assert_eq!(r3, RectU64::of(0, 0, u64::MAX / 2 - 1, u64::MAX));

    let mut r4 = RectU64::largest();
    wrapping_add_assign(&mut r4, &RectI64::of(0, 0, 0, i64::MAX));
    assert_eq!(r4, RectU64::of(0, 0, u64::MAX, u64::MAX / 2 - 1));
}
