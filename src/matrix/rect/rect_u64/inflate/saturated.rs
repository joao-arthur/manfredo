...
mod tests {
    ...
    fn try_assign_inflate_out_of_bounds() {
        ...
        let mut r_row = RectU64::of(0, 10, u64::MAX, 20);
        assert_eq!(try_assign_inflate(&mut r_row), None);
        assert_eq!(r_row, RectU64::of(0, 10, u64::MAX, 20));

        let mut r_col = RectU64::of(10, 0, 20, u64::MAX);
        assert_eq!(try_assign_inflate(&mut r_col), None);
        assert_eq!(r_col, RectU64::of(10, 0, 20, u64::MAX));
    }

    #[test]
    fn try_inflate_min_bounds() {
        assert_eq!(try_inflate(&RectU64::of(7, 2, 17, 13)), Some(RectU64::of(6, 1, 18, 14)));
        assert_eq!(try_inflate(&RectU64::of(6, 1, 18, 14)), Some(RectU64::of(5, 0, 19, 15)));
        assert_eq!(try_inflate(&RectU64::of(5, 0, 19, 15)), Some(RectU64::of(4, 0, 20, 17)));
        assert_eq!(try_inflate(&RectU64::of(4, 0, 20, 17)), Some(RectU64::of(3, 0, 21, 19)));
        assert_eq!(try_inflate(&RectU64::of(3, 0, 21, 19)), Some(RectU64::of(2, 0, 22, 21)));
        assert_eq!(try_inflate(&RectU64::of(2, 0, 22, 21)), Some(RectU64::of(1, 0, 23, 23)));
        assert_eq!(try_inflate(&RectU64::of(1, 0, 23, 23)), Some(RectU64::of(0, 0, 24, 25)));
        assert_eq!(try_inflate(&RectU64::of(0, 0, 24, 25)), Some(RectU64::of(0, 0, 26, 27)));
    }
    ...
    fn try_inflate_out_of_bounds() {
        ...
        assert_eq!(try_inflate(&RectU64::of(10, 0, 20, u64::MAX)), None);
    }
    ...
    fn inflate_min_bounds() {
        assert_eq!(inflate(&RectU64::of(7, 2, 17, 13)), RectU64::of(6, 1, 18, 14));
        assert_eq!(inflate(&RectU64::of(6, 1, 18, 14)), RectU64::of(5, 0, 19, 15));
        assert_eq!(inflate(&RectU64::of(5, 0, 19, 15)), RectU64::of(4, 0, 20, 17));
        assert_eq!(inflate(&RectU64::of(4, 0, 20, 17)), RectU64::of(3, 0, 21, 19));
        assert_eq!(inflate(&RectU64::of(3, 0, 21, 19)), RectU64::of(2, 0, 22, 21));
        assert_eq!(inflate(&RectU64::of(2, 0, 22, 21)), RectU64::of(1, 0, 23, 23));
        assert_eq!(inflate(&RectU64::of(1, 0, 23, 23)), RectU64::of(0, 0, 24, 25));
        assert_eq!(inflate(&RectU64::of(0, 0, 24, 25)), RectU64::of(0, 0, 26, 27));
    }
