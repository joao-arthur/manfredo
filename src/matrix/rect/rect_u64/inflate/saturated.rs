...
mod tests {
    ...
    fn saturating_inflate_max_bounds() {
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 33, u64::MAX - 17, u64::MAX - 5, u64::MAX - 3)),
            RectU64::of(u64::MAX - 34, u64::MAX - 18, u64::MAX - 4, u64::MAX - 2)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 34, u64::MAX - 18, u64::MAX - 4, u64::MAX - 2)),
            RectU64::of(u64::MAX - 35, u64::MAX - 19, u64::MAX - 3, u64::MAX - 1)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 35, u64::MAX - 19, u64::MAX - 3, u64::MAX - 1)),
            RectU64::of(u64::MAX - 36, u64::MAX - 20, u64::MAX - 2, u64::MAX)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 36, u64::MAX - 20, u64::MAX - 2, u64::MAX)),
            RectU64::of(u64::MAX - 37, u64::MAX - 22, u64::MAX - 1, u64::MAX)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 37, u64::MAX - 22, u64::MAX - 1, u64::MAX)),
            RectU64::of(u64::MAX - 38, u64::MAX - 24, u64::MAX, u64::MAX)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 38, u64::MAX - 24, u64::MAX, u64::MAX)),
            RectU64::of(u64::MAX - 40, u64::MAX - 26, u64::MAX, u64::MAX)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 40, u64::MAX - 26, u64::MAX, u64::MAX)),
            RectU64::of(u64::MAX - 42, u64::MAX - 28, u64::MAX, u64::MAX)
        );
        assert_eq!(
            saturating_inflate(&RectU64::of(u64::MAX - 42, u64::MAX - 28, u64::MAX, u64::MAX)),
