...
mod tests {
    ...
    fn try_assign_resize_odd_small_rect_out_of_bounds() {
        ...
        assert_eq!(r_min_row, RectU64::of(0, 2, 2, 4));

        let mut r_min_col = RectU64::of(2, 0, 4, 2);
        assert_eq!(try_assign_resize(&mut r_min_col, 5), None);
        assert_eq!(r_min_col, RectU64::of(2, 0, 4, 2));

        let mut r_max = RectU64::of(u64::MAX - 2, u64::MAX - 2, u64::MAX, u64::MAX);
        assert_eq!(try_assign_resize(&mut r_max, 5), None);
        assert_eq!(r_max, RectU64::of(u64::MAX - 2, u64::MAX - 2, u64::MAX, u64::MAX));

        let mut r_max_row = RectU64::of(u64::MAX - 2, u64::MAX - 4, u64::MAX, u64::MAX - 2);
        assert_eq!(try_assign_resize(&mut r_max_row, 5), None);
        assert_eq!(r_max_row, RectU64::of(u64::MAX - 2, u64::MAX - 4, u64::MAX, u64::MAX - 2));

        let mut r_max_col = RectU64::of(u64::MAX - 4, u64::MAX - 2, u64::MAX - 2, u64::MAX);
        assert_eq!(try_assign_resize(&mut r_max_col, 5), None);
        assert_eq!(r_max_col, RectU64::of(u64::MAX - 4, u64::MAX - 2, u64::MAX - 2, u64::MAX));
    }
    ...
    fn try_assign_resize_even_small_rect_out_of_bounds() {
        ...
        let mut r_min_row = RectU64::of(0, 3, 3, 6);
        assert_eq!(try_assign_resize(&mut r_min_row, 6), None);
        assert_eq!(r_min_row, RectU64::of(0, 3, 3, 6));

        let mut r_min_col = RectU64::of(3, 0, 6, 3);
        assert_eq!(try_assign_resize(&mut r_min_col, 6), None);
        assert_eq!(r_min_col, RectU64::of(3, 0, 6, 3));
        ...
        let mut r_max_row = RectU64::of(u64::MAX - 3, u64::MAX - 6, u64::MAX, u64::MAX - 3);
        assert_eq!(try_assign_resize(&mut r_max_row, 6), None);
        assert_eq!(r_max_row, RectU64::of(u64::MAX - 3, u64::MAX - 6, u64::MAX, u64::MAX - 3));

        let mut r_max_col = RectU64::of(u64::MAX - 6, u64::MAX - 3, u64::MAX - 3, u64::MAX);
        assert_eq!(try_assign_resize(&mut r_max_col, 6), None);
        assert_eq!(r_max_col, RectU64::of(u64::MAX - 6, u64::MAX - 3, u64::MAX - 3, u64::MAX));
    }
