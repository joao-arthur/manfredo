...
fn same_size() {
    ...
    assert_eq!(try_saturating_resize(&RectU64::of(MAX - 2, MAX - 2, MAX, MAX), 3), Some(RectU64::of(MAX - 2, MAX - 2, MAX, MAX)));
    assert_eq!(try_saturating_resize(&RectU64::of(MAX - 3, MAX - 3, MAX, MAX), 4), Some(RectU64::of(MAX - 3, MAX - 3, MAX, MAX)));
}

#[test]
fn bounds() {
    assert_eq!(try_saturating_resize(&RectU64::of(0, 0, 2, 2), 11), Some(RectU64::of(0, 0, 10, 10)));
    assert_eq!(try_saturating_resize(&RectU64::of(MAX - 2, MAX - 2, MAX, MAX), 11), Some(RectU64::of(MAX - 10, MAX - 10, MAX, MAX)));
}

#[test]
fn small_rect_limits() {
    assert_eq!(try_saturating_resize(&RectU64::of(0, 0, 2, 2), MAX), Some(RectU64::of(0, 0, MAX - 1, MAX - 1)));
    assert_eq!(try_saturating_resize(&RectU64::of(MAX - 2, MAX - 2, MAX, MAX), MAX), Some(RectU64::of(1, 1, MAX, MAX)));
}

#[test]
fn big_rect_limits() {
    assert_eq!(try_saturating_resize(&RectU64::of(0, 0, MAX - 1, MAX - 1), MAX), Some(RectU64::of(0, 0, MAX - 1, MAX - 1)));
    assert_eq!(try_saturating_resize(&RectU64::of(1, 1, MAX, MAX), MAX), Some(RectU64::of(1, 1, MAX, MAX)));
    assert_eq!(try_saturating_resize(&RectU64::largest(), MAX), Some(RectU64::of(0, 0, MAX - 1, MAX - 1)));
}
