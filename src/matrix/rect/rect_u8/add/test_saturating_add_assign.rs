...
fn limits_out_of_bounds() {
    let mut r = RectU8::largest();
    saturating_add_assign(&mut r, &RectI::of(i8::MIN, 0, 0, 0));
    assert_eq!(r, RectU8::largest());
    saturating_add_assign(&mut r, &RectI::of(0, i8::MIN, 0, 0));
    assert_eq!(r, RectU8::largest());
    saturating_add_assign(&mut r, &RectI::of(0, 0, i8::MAX, 0));
    assert_eq!(r, RectU8::largest());
    saturating_add_assign(&mut r, &RectI::of(0, 0, 0, i8::MAX));
    assert_eq!(r, RectU8::largest());
}
