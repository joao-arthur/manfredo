...
#[test]
fn test() {
    assert_eq!(try_checked_add(&RectU8::of(0, 0, 12, 15), &RectI::of(5, 4, 3, 2)), Some(RectU8::of(5, 4, 15, 17)));
    assert_eq!(try_checked_add(&RectU8::of(5, 4, 15, 20), &RectI::of(-4, -3, -2, -1)), Some(RectU8::of(1, 1, 13, 19)));
}

#[test]
fn to_bounds() {
    assert_eq!(try_checked_add(&RectU8::of(2, 5, MAX - 2, MAX - 5), &RectI::of(-2, -5, 2, 5)), Some(RectU8::largest()));
    assert_eq!(try_checked_add(&RectU8::of(2, 5, MAX, MAX), &RectI::of(-2, -5, 0, 0)), Some(RectU8::largest()));
    assert_eq!(try_checked_add(&RectU8::of(0, 0, MAX - 2, MAX - 5), &RectI::of(0, 0, 2, 5)), Some(RectU8::largest()));
}
