...
pub fn assign_translate(r: &mut RectU8, delta: &PointI8) {
    ...
    let clamped_row = temp_min_row.clamp(0, i16::from(u8::MAX) - i16::from(dx));
    let clamped_col = temp_min_col.clamp(0, i16::from(u8::MAX) - i16::from(dy));
...
mod tests {
    ...
    fn translate_small_rect_out_of_bounds() {
        assert_eq!(translate(&RectU8::of(10, 5, 20, 30), &PointI8::of(-20, -20)), RectU8::of(0, 0, 10, 25));
        assert_eq!(
    ...
    fn translate_big_rect_out_of_bounds() {
        assert_eq!(translate(&RectU8::of(10, 5, u8::MAX, u8::MAX), &PointI8::of(-20, -20)), RectU8::of(0, 0, u8::MAX - 10, u8::MAX - 5));
        assert_eq!(translate(&RectU8::of(0, 0, u8::MAX - 5, u8::MAX - 10), &PointI8::of(20, 20)), RectU8::of(5, 10, u8::MAX, u8::MAX));
    }

    #[test]
    fn translate_small_rect_limits_out_of_bounds() {
        assert_eq!(translate(&RectU8::of(1, 1, 10, 10), &PointI8::min()), RectU8::of(0, 0, 9, 9));
        assert_eq!(
    ...
    fn translate_big_rect_limits_out_of_bounds() {
        assert_eq!(translate(&RectU8::of(1, 1, u8::MAX, u8::MAX), &PointI8::min()), RectU8::of(0, 0, u8::MAX - 1, u8::MAX - 1));
        assert_eq!(translate(&RectU8::of(0, 0, u8::MAX - 1, u8::MAX - 1), &PointI8::max()), RectU8::of(1, 1, u8::MAX, u8::MAX));
    }
}
