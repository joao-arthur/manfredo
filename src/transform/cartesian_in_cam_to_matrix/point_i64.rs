...
mod tests {
    ...
    fn bounds() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::min(), &cam), MatrixPoint::of(u64::MAX, 0));
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(i64::MAX, i64::MIN), &cam), MatrixPoint::max());
