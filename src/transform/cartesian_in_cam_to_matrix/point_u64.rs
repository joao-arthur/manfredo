...
mod tests {
    ...
    fn cartesian_to_matrix_in_cam_bounds() {
        ...
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(u64::MAX, 0), &cam), MatrixPoint::of(u64::MAX, u64::MAX));
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(0, u64::MAX), &cam), MatrixPoint::of(0, 0));
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(u64::MAX, u64::MAX), &cam), MatrixPoint::of(0, u64::MAX));
    }
