...
mod tests {
    ...
    fn cartesian_in_cam_to_matrix_in_cam_bounds() {
        ...
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(u8::MAX, 0), &cam), MatrixPoint::of(u8::MAX, u8::MAX));
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(0, u8::MAX), &cam), MatrixPoint::of(0, 0));
        assert_eq!(cartesian_in_cam_to_matrix(&CartesianPoint::of(u8::MAX, u8::MAX), &cam), MatrixPoint::of(0, u8::MAX));
    }
