...
mod tests {
    ...
    fn bounds() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::min(), &cam), Matrix::new(u16::MAX, 0));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MAX, i16::MIN), &cam), Matrix::max());
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MIN, i16::MAX), &cam), Matrix::min());
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::max(), &cam), Matrix::new(0, u16::MAX));
    }

    #[test]
    fn sequence_min() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MIN + 1, i16::MIN + 1), &cam), Matrix::new(u16::MAX - 1, 1));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MIN + 2, i16::MIN + 2), &cam), Matrix::new(u16::MAX - 2, 2));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MIN + 3, i16::MIN + 3), &cam), Matrix::new(u16::MAX - 3, 3));
    }

    #[test]
    fn sequence_max() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MAX - 1, i16::MAX - 1), &cam), Matrix::new(1, u16::MAX - 1));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MAX - 2, i16::MAX - 2), &cam), Matrix::new(2, u16::MAX - 2));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::new(i16::MAX - 3, i16::MAX - 3), &cam), Matrix::new(3, u16::MAX - 3));
    }
}
