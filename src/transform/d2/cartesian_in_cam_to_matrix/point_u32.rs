...
mod tests {
    ...
    fn bounds() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(0, 0), &cam), Matrix::of(u32::MAX, 0));
    ...
    fn sequence_min() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(1, 1), &cam), Matrix::of(u32::MAX - 1, 1));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(2, 2), &cam), Matrix::of(u32::MAX - 2, 2));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(3, 3), &cam), Matrix::of(u32::MAX - 3, 3));
    }

    #[test]
    fn sequence_max() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(u32::MAX - 1, u32::MAX - 1), &cam), Matrix::of(1, u32::MAX - 1));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(u32::MAX - 2, u32::MAX - 2), &cam), Matrix::of(2, u32::MAX - 2));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(u32::MAX - 3, u32::MAX - 3), &cam), Matrix::of(3, u32::MAX - 3));
    }
}
