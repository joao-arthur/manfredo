...
mod tests {
    ...
    fn bounds() {
        let cam = Cam::largest();
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(0, 0), &cam), Matrix::of(u64::MAX, 0));
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(u64::MAX, 0), &cam), Matrix::max());
        assert_eq!(cartesian_in_cam_to_matrix(&Cartesian::of(0, u64::MAX), &cam), Matrix::of(0, 0));
