...
mod tests {
    ...
    fn test_3x3() {
        ...
        assert_eq!(cartesian_to_matrix_in_cam(&Cartesian::of(0, u8::MAX), &cam), Matrix::of(0, 0));
    ...
    fn bounds() {
        let cam = Cam::largest();
        assert_eq!(cartesian_to_matrix_in_cam(&Cartesian::of(0, 0), &cam), Matrix::of(u8::MAX, 0));
