...
mod tests {
    ...
    fn edges() {
        let cam = Cam::largest();
        assert_eq!(matrix_to_cartesian_in_cam(&Matrix::of(0, 0), &cam), Cartesian::of(0, u16::MAX));
        assert_eq!(matrix_to_cartesian_in_cam(&Matrix::of(u16::MAX, 0), &cam), Cartesian::of(0, 0));
