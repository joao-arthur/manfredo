...
pub fn matrix_in_cam_to_cartesian(point: &MatrixPoint, cam: &Cam) -> CartesianPoint {
    let x = i32::from(point.col) - i32::from(cam.min.col);
    let y = i32::from(cam.max.row) - i32::from(point.row);
...
mod tests {
    ...
    fn matrix_in_cam_to_cartesian_edges() {
        ...
        assert_eq!(matrix_in_cam_to_cartesian(&MatrixPoint::of(0, u16::MAX), &cam), CartesianPoint::of(u16::MAX, u16::MAX));
        assert_eq!(matrix_in_cam_to_cartesian(&MatrixPoint::of(u16::MAX, u16::MAX), &cam), CartesianPoint::of(u16::MAX, 0));
    }
