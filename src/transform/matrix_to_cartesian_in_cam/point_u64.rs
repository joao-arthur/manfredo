...
pub fn matrix_to_cartesian_in_cam(point: &MatrixPoint, cam: &Cam) -> CartesianPoint {
    let x = u128::from(point.col) + u128::from(cam.min.x);
    let y = u128::from(cam.max.y) - u128::from(point.row);
    CartesianPoint { x: x as u64, y: y as u64 }
}
...
mod tests {
    ...
    fn matrix_to_cartesian_in_cam_edges() {
        ...
        assert_eq!(matrix_to_cartesian_in_cam(&MatrixPoint::of(0, u64::MAX), &cam), CartesianPoint::of(u64::MAX, u64::MAX));
        assert_eq!(matrix_to_cartesian_in_cam(&MatrixPoint::of(u64::MAX, u64::MAX), &cam), CartesianPoint::of(u64::MAX, 0));
    }
